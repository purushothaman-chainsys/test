...
public class PreferencesSubmitController extends BaseController {
    ...
    public ModelAndView preferenceSubmit(@Valid @ModelAttribute("userPreferences") UserPreference userPreferences, BindingResult results, ModelMap m,
        ...
        try {
            ...
            m.addAttribute(SYSTEMERROR, getMessage("error.common.exception"));
            forwardKey = ERRORPAGE;
        }

        if (!m.containsAttribute(ERRORPAGE)) {
