...
public class WorkPerformancesList extends BaseSearchVOB {
	...
	private Collection invalidWorkPerformances = null;
	 ...
	 * @return Collection
	 */
	public Collection getInvalidWorkPerformances() {
	 ...
	 */
	public void setInvalidWorkPerformances(Collection invalidWorkPerformances) {
