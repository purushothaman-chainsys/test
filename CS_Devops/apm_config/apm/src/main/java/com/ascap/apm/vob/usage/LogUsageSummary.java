...
public class LogUsageSummary extends BaseSearchVOB {
    ...
    private Collection<LogUsageRequest> logUsages; 
    ...
    public Collection<LogUsageRequest> getLogUsages() {
        return logUsages;
    }


    public void setLogUsages(Collection<LogUsageRequest> logUsages) {
