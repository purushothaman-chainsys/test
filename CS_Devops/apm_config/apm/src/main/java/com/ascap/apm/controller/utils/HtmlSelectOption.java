...
public class HtmlSelectOption implements java.io.Serializable {
     ...
     */
    public static Collection<Object> getOptionsValues(Map<?, ?> hmap) {
     ...
     */
    public static Collection<Object> getOptionsValues(List<?> arrList) {
     ...
     */
    public static Collection<Object> getLookUpTable(String lookUpKey) {
