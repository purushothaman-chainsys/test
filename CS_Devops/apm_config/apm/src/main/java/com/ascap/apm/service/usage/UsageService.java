...
public interface UsageService {
    ...
    public ApmPerformanceBulkRequestList cloneWorkPerformances(
        ApmPerformanceBulkRequestList apmPerformanceBulkRequestList)
            throws PrepSystemException, PrepFunctionalException;

    public ApmPerformanceBulkRequestList updateApmPerfBulkRequestList(
        ApmPerformanceBulkRequestList apmPerformanceBulkRequestList) throws PrepSystemException ;

    public EOLearnedMatchList deleteEOLearnedMatchList(EOLearnedMatchList apmLearnedMatchList) throws PrepSystemException, PrepFunctionalException;

    public EOLearnedMatchList getEOLearnedMatchList(EOLearnedMatchList eoLearnedMatchList) throws PrepSystemException, PrepFunctionalException;

    public List<ApmWork> validateApmWorks(List<ApmWork> col) throws PrepSystemException, PrepFunctionalException;

    public EOLearnedMatchList updateEOLearnedMatchList(EOLearnedMatchList eoLearnedMatchList) throws PrepSystemException, PrepFunctionalException;

    public EOLearnedMatch getEOLearnedMatchMedleyWorkInformation(EOLearnedMatchList eoLearnedMatchList) throws PrepSystemException, PrepFunctionalException;

    public EOLearnedMatch updateEOLearnedMatchMultiple(EOLearnedMatch apmLearnedMatch) throws PrepSystemException, PrepFunctionalException;

    public EOLearnedMatch addEOLearnedMatch(EOLearnedMatch apmLearnedMatch) throws PrepSystemException, PrepFunctionalException;
