...
//  	alert(index + '::::::::::::::::::: ' + $(this).html() + something.length);   	
	...
	var xxx = 'manoj';
					...
					var option = { width: 150, items: [
                            { text: "Print", icon: "/APMWeb/images/contextmenu/ac0036-16.gif", alias: "1-1", action: menuAction },
...
//                          },
//                            { type: "splitLine" },
                            { text: "Filter", icon: "/APMWeb/images/contextmenu/wi0124-16.gif", alias: "1-5", type: "group", width: 100, items: [
	                             { text: "On", icon: "/APMWeb/images/contextmenu/wi0062-16.gif", alias: "1-5-1", action: menuAction },
	                             { text: "Off", icon: "/APMWeb/images/contextmenu/wi0062-16.gif", alias: "1-5-3", action: menuAction }
...
//	  				alert($(this).className);
	  				option.items[4].items[index].icon = "/APMWeb/images/contextmenu/wi0009-16.gif";
