...
$.each(something, function(index, value) { 
 ...
 var option = { width: 150, items: [
                            ...
                            { text: xxx, icon: "/PrepWeb/images/contextmenu/ac0036-16.gif", alias: "1-2", action: menuAction },
                            
                            
                            { text: "Item Three", icon: "/PrepWeb/images/contextmenu/ei0021-16.gif", alias: "1-3", action: menuAction },
                            { type: "splitLine" },
                            { text: "Hide Columns", icon: "/PrepWeb/images/contextmenu/wi0009-16.gif", alias: "1-4", type: "group", width: 170, items: [	                       
                            ]
                            },
                            { type: "splitLine" },
                            { text: "Item Four", icon: "/PrepWeb/images/contextmenu/wi0124-16.gif", alias: "1-5", action: menuAction },
                            { text: "Group Three", icon: "/PrepWeb/images/contextmenu/wi0062-16.gif", alias: "1-6", type: "group", width: 180, items: [
	                            { text: "Item One", icon: "/PrepWeb/images/contextmenu/wi0096-16.gif", alias: "4-1", action: menuAction },
	                            { text: "Item Two", icon: "/PrepWeb/images/contextmenu/wi0122-16.gif", alias: "4-2", action: menuAction }
                            ]
                            }
                            ], onShow: applyrule,
			...
			$.each(something, function(index, value) { 	
  				...
  				option.items[5].items[index].icon = "/PrepWeb/images/contextmenu/wi0124-16.gif";
...
function buildContextMenuXX() {
 var option = { width: 150, items: [
                            { text: "Print", icon: "PrepWeb/images/contextmenu/ac0036-16.gif", alias: "1-1", action: menuAction },
                            { text: "Toggle Columns", icon: "../images/contextmenu/ac0036-16.gif", alias: "1-2", action: menuAction },
                            { text: "Item Three", icon: "../images/contextmenu/ei0021-16.gif", alias: "1-3", action: menuAction },
                            { type: "splitLine" },
                            { text: "Hide Columns", icon: "PrepWeb/images/contextmenu/wi0009-16.gif", alias: "1-4", type: "group", width: 170, items: [
	                            { text: "Group Three", icon: "PrepWeb/images/contextmenu/wi0054-16.gif", alias: "2-2", type: "group", width: 190, items: [
		                            { text: "Group3 Item One", icon: "/PrepWeb/images/contextmenu/wi0062-16.gif", alias: "3-1", action: menuAction },
		                            { text: "Group3 Item Tow", icon: "/PrepWeb/images/contextmenu/wi0063-16.gif", alias: "3-2", action: menuAction }
	                            ]
	                            },
	                            { text: "Group Two Item1", icon: "/PrepWeb/images/contextmenu/wi0096-16.gif", alias: "2-1", action: menuAction },
	                            { text: "Group Two Item1", icon: "/PrepWeb/images/contextmenu/wi0111-16.gif", alias: "2-3", action: menuAction },
	                            { text: "Group Two Item1", icon: "/PrepWeb/images/contextmenu/wi0122-16.gif", alias: "2-4", action: menuAction }
                            ]
                            },
                            { type: "splitLine" },
                            { text: "Item Four", icon: "/PrepWeb/images/contextmenu/wi0124-16.gif", alias: "1-5", action: menuAction },
