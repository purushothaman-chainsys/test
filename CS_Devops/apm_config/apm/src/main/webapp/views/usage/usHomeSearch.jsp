...
function openMusicUserSearch() {
	var effDate = '';
	window.open('<%=request.getContextPath()%>/musicUserSearch?filterEffectiveDate='+effDate,'', 'width=800,height=500,toolbar=0,status=1,scrollbars=1,location=0,resizable=0');
}   
...
<fieldset class="fieldsetfull" style="position: relative;"><legend class="legendfull" style="top: -0.7em;">Performance Search [PS-100]</legend>
	...
	<div  class="col-3-4" style="float:left">
			...
			<form:select path="postedFlag" style="width:120px;">
				...
				<form:option value="N">Not Posted</form:option>
				<form:option value="Y">Posted</form:option>
			</form:select><br>
