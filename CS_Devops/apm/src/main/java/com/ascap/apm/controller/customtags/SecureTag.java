...
public class SecureTag extends BodyTagSupport {
	...
	public int doAfterBody() throws JspException {
		if (bodyContent != null) {
			try {
				...
				outputString = buildButtonTypeContent(outputString, content);
				outputString = buildAnchorTypeContent(outputString, content);
				outputString = buildReportTypeContent(outputString, content);
				outputString = buildMenuTypeContent(outputString, content);
				outputString = buildHideTypeContent(outputString);
				outputString = buildSelectTypeContent(outputString, content);
				outputString = buildMultiBoxTypeContent(outputString, content);
				outputString = buildCheckBoxTypeContent(outputString, content);
				outputString = buildTextTypeContent(outputString, content);
				outputString = buildTextAreaTypeContent(outputString, content);
	...
	private StringBuilder buildTextAreaTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildTextTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildCheckBoxTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildMultiBoxTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildSelectTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildHideTypeContent(StringBuilder outputString) {
		String content = null;
		if (type != null && type.trim().equals(SecurityConstants.HIDE_TYPE) && !hasPermission) {
			...
			outputString= new StringBuilder(content);
		}
		return outputString;
	}

	private StringBuilder  buildMenuTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildReportTypeContent(StringBuilder outputString, String content) {
...
return outputString;
	...
	private StringBuilder buildAnchorTypeContent(StringBuilder outputString, String content) {
	...
	private StringBuilder buildButtonTypeContent(StringBuilder outputString, String content) {
