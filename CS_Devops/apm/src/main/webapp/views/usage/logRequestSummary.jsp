...
function release(obj) {  
	...
	if($("input[name=selectedLogRequest]:checked").length === 0) {	
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.release.selection"/></span>');
		//unCheckSub(obj);
	 	location.href="#"; 
	 	return;
	}
	...
	$("input[name=selectedLogRequest]:checked").each(function(){
		...
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.release.nousage"/></span>');
		//unCheckSub(obj);
	 	location.href="#"; 
	 	return;
		}
		...
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.release.haveerrors"/></span>');
		//unCheckSub(obj);
	 	location.href="#"; 
	 	return;
		}
		...
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.release.nousageandhaveerrors"/></span>');
		//unCheckSub(obj);
	 	location.href="#"; 
	 	return;
		}
...
function del(obj) {  
	...
	if (filterSupplierCode != '' || filterStatus != ''){ 
	 $("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.delete.filters"/></span>');
	 	location.href="#"; 
	 	return;
	} 
...
function filter() { 
            ...
            if(  $("input[name=filtertargetSurveyYearQuarter]").val()  == '' || 
				...
				$("#serverErrorMessages").html("");
				$("#errorMessages").html("");
				$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.filter.tgtsurvyearqtrblank"/></span>');
				unCheckSub(obj);
			 	location.href="#"; 
			 	return;
			}
...
function usage_OLD(obj) {   
	...
	if($("input[name=selectedLogRequest]:checked").length === 0) {	
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.gotousage.selection"/></span>');
	 	location.href="#"; 
	 	return;
	} 
	...
	if($("input[name=selectedLogRequest]:checked").length > 1) {	
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.gotousage.multiselection"/></span>');
		//unCheckSub(obj);
	 	location.href="#"; 
	 	return;
	}
	...
	$("input[name=selectedLogRequest]:checked").each(function(){ 
	 ...
	 if( distQtrErr) {	
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.logrequest.gotousage.tgtsurvyearqtrnotactive"/></span>');
	 	location.href="#"; 
	 	return;
		}
...
<form:form action="logrequestSummary" modelAttribute="logRequestSummary">
...
<tr>  </tr>
 <tr> 
      ...
      <td align="left"  width="10%">	  
		...
		Found <c:out value="${logRequestSummary.searchResultRows}"></c:out> Result(s) 
	  </td>


 <td align="left" width="15%" >
<%pageContext.setAttribute("totalPg", String.valueOf(0), PageContext.PAGE_SCOPE);%>
<c:if test="${logRequestSummary.totalPg ne totalPg }">
			Page <c:out value="${logRequestSummary.currentPg}"></c:out> of  
			<c:out value="${logRequestSummary.totalPg}"></c:out>
		 </c:if>
	  </td>
...
<tbody>
 ...
 <c:if test="${not empty logRequestSummary.searchResults}"> 
 <c:forEach var="logRequestResult" items= "${logRequestSummary.searchResults}" varStatus="currentIndexId">
 <c:choose>
 ...
 <tr> 
	  ...
	  <td align="right" width="15%"> 
		...
		<%pageContext.setAttribute("canDeleteLogRequest","Y", PageContext.PAGE_SCOPE);%>
         <c:if test="${logRequestSummary.canDeleteLogRequest eq canDeleteLogRequest }">
