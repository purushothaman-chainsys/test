...
window.open('<%=request.getContextPath()%>/toModule.do?prefix=/usage&page=/musicUserSearch.do?filterEffectiveDate='+effDate,'', 'width=800,height=500,toolbar=0,status=1,scrollbars=1,location=0,resizable=0');
}
...
<form:form action="programPerformanceMultiAction"  name ="programPerformanceForm" modelAttribute="programPerformance">
		<font color="#FF0000">
		<form:errors path="musicUserId"></form:errors><br>
		<form:errors path="performanceStartDate"></form:errors><br>
		<form:errors path ="performanceStartTime"></form:errors><br>
		<form:errors path ="performanceEndDate"></form:errors><br>
		<form:errors path ="performanceEndTime"></form:errors><br></font>
