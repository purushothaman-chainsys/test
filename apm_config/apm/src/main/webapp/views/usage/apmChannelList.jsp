...
function update(thisObj) {
	...
	if(!rowsSelected) {
		errMessage += '<li><spring:message code="error.apm.channels.update.selection"/>';
 ...
 <table class="errortable" style="font-size:1.2em;width:1000px;margin:0 auto;border:0px;align:left;">
		<tr>
			<td>
				...
				<span class="txtGreen" style="text-align:left;"> <c:out value="${systemmessage}" /></span>
				<span class="txtRed" style="text-align:left;"><c:out value="${systemerror}" /></span>
				</div>
