...
public class MusicUserSearchController extends BaseUsageController {
    ...
    public String musicUserSearch(@ModelAttribute("musicUserSearch") MusicUserSearch musicUserSearch,BindingResult result, HttpServletRequest request,
    ...
    private String musicUserPartySearch(MusicUserSearch musicUserSearchForm, HttpServletRequest request, Model m)
        ...
        if (Utils.isEmptyOrNull(musicUserSearchForm.getFilterEffectiveDate())) {
            m.addAttribute(SYSTEMERROR, messageSource.getMessage("error.apm.effectivedate.required", new Object[] {}, Locale.getDefault()));
            return USPAARTYSEARCH;
        }
        ...
        try {
            ...
            log.error("Error in musicUserPartySearch method in MusicUserSearchAction" + e);
            forwardKey = ERRORPAGE;
        }
        log.debug("Exiting musicUserPartySearch method in MusicUserSearchAction");
        return forwardKey;
    }
