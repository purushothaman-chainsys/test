...
public class PerformanceSearch extends BaseSearchVOB {
    ...
    private List<Serializable> executionProfilingMessages = null;
    ...
    private List<Serializable> invalidWorkPerformances = null;

    private List<Serializable> audits = null;
     ...
     * @return Collection
     */
    public List<Serializable> getInvalidWorkPerformances() {
     ...
     */
    public void setInvalidWorkPerformances(List<Serializable> invalidWorkPerformances) {
     ...
     */
    public List<Serializable> getExecutionProfilingMessages() {
     ...
     */
    public void setExecutionProfilingMessages(List<Serializable> executionProfilingMessages) {
     ...
     * @return the audits
     */
    public List<Serializable> getAudits() {
        return audits;
    }
     ...
     */
    public void setAudits(List<Serializable> audits) {
        this.audits = audits;
    }
