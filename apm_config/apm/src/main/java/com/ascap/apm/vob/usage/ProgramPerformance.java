...
public class ProgramPerformance extends BaseMultiVOB {
    ...
    @NotEmpty(message = "{error.usage.programPerformance.required.musicUserId}")
    private String musicUserId = null;

    private String musicUserTypeCode = null;

    private String licenseTypeCode = null;
    @NotEmpty(message = "{error.usage.programPerformanceForm.required.performanceStartDate}")
    private String performanceStartDate = null;
    @NotEmpty(message = "{error.usage.programPerformanceForm.required.performanceStartTime}")
    private String performanceStartTime = null;
    @NotEmpty(message = "{error.usage.programPerformanceForm.required.performanceEndDate}")
    private String performanceEndDate = null;

    @NotEmpty(message ="{error.usage.programPerformanceForm.required.performanceEndTime}")
