...
//	 name of the prompt
	...
	// List of values
	private List  listofDefaultValues;
	private List  rangeValues;
	private List  multipleValues;
	private List  inputRangeValues;
	...
	Parameter paramer1 = new Parameter(1,"empId","employID","Rep01","repEID","1001","int","text","10",null,"employee id info",null,null); 
	Parameter paramer2 = new Parameter(2,"eName","emp-Name","Rep01","repEname","Murali","string","checkbox","murali",null,"Emp Name info",null,null); 
	Parameter paramer3 = new Parameter(3,"custName","EMP Desc","Rep01","repDesc","Employee","string","multiple","computers",null,"Department info",null,null); 
	return null;
	 ...
	 * @return List
	 */
	public List getListofDefaultValues() {
	 ...
	 */
	public void setListofDefaultValues(List listofDefaultValues) {
		this.listofDefaultValues = listofDefaultValues;
	}
	...
	public void setParamID(int paramID) {
		//System.out.println("setParamID" +paramID);
		this.paramID = paramID;
	}
	 ...
	 * @return List
	 */
	public List getInputRangeValues() {
	 ...
	 */
	public void setInputRangeValues(List inputRangeValues) {
