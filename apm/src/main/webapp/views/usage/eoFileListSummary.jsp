...
<% 	com.ascap.apm.vob.usage.EOFileList oForm = (com.ascap.apm.vob.usage.EOFileList) request.getAttribute("eoFileList"); %>
...
function applyToSelected(obj) {
	...
	if($.trim(val) === '') {
		...
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.perfQuartersAll.blank"/></span>');
 		location.href="#"; 
 		return;
	}
	...
	if($("table#mainData tr input[name='selectedIndex']:checked").length > 0) {		
		...
		$("#serverErrorMessages").html("");
		$("#errorMessages").html("");
		$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.perfQuartersAll.selection.invalid"/></span>');
 		location.href="#"; 
 		return;
	}
	...
	if(!filter) {
		...
		if($('select[name=filterPerformanceQuarter]').val() == ''
			...
			&& $('select[name=filterCompletedSupplierCode]').val() == ''
				...
				$("#serverErrorMessages").html("");
				$("#errorMessages").html("");
				$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.perfQuartersANDdistQtr.blank"/></span>');
		 		location.href="#"; 
		 		return;
		}
	}
...
function rollup(obj) {
		...
		$("#uierror").html("");
		if($("table#mainData tr input[name=selectedIndex]:checked").length == 0) {	
			$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.file.selection.invalid"/></span>');
			unCheckSub(obj);
	 		location.href="#"; 
	 		return;
	 	}
		...
		if(!distqtrexists) {	
			$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.distqtr.invalid"/></span>');
			unCheckSub(obj);
	 		location.href="#"; 
	 		return;
	 	}
		if(!distqtrvalid) {	
			$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.distqtr.lt.currentqtr"/></span>');
			unCheckSub(obj);
	 		location.href="#"; 
	 		return;
	 	}
		...
		unCheckSub(obj);
	 	...
	 	return;
			...
			if(!perfQtrExists) {
				$("#serverErrorMessages").html("");
				$("#errorMessages").html("");
				$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.perfqtr.invalid"/></span>');		
				unCheckSub(obj);
		 		location.href="#"; 
		 		return;
			}	
			...
			if(!perfPeriodExists) {
				$("#serverErrorMessages").html("");
				$("#errorMessages").html("");
				$("#uierror").html('<span class=txtRed><li><spring:message code="us.error.apm.filedash.perfperiod.invalid"/></span>');		
				unCheckSub(obj);
		 		location.href="#"; 
		 		return;
			}
...
Processing Distribution Quarter: <b><c:out value="${eoFileList.activeSurveyQuarterApm}"/>
(<c:out value="${eoFileList.currentDistQuarterEO}"/>)</b>
</div>
<form:form action="eoFiles" modelAttribute="eoFileList">
...
<div class="uibox uibox_pend"><span class="uiboxtext"><a href="#" onclick="javascript:details('NEW');">New File Review (<c:out value="${eoFileList.newReviewFiles}"/>)</a> </span></div>
<div class="uibox uibox_pend"><span class="uiboxtext"><a href="#" onclick="javascript:details('CHANNELS');">Channel Review (<c:out value="${eoFileList.channelReviewFiles}"/>)</a> </span></div>
<div class="uibox uibox_pend"><span class="uiboxtext"><a href="#" onclick="javascript:details('LOAD2APM_PEND');">Load to APM (<c:out value="${eoFileList.rolllupReviewFiles}"/>)</a> </span></div>
</div>
</td>
</tr>
<tr height="8px"></tr>
...
<div class="uibox uibox_prog"><span class="uiboxtext"><a href="#" onclick="javascript:details('LOAD2EO_PEND');">Load To EO DB (<c:out value="${eoFileList.eoLoadFiles}"/>)</a> </span></div>
<div class="uibox uibox_prog"><span class="uiboxtext"><a href="#" onclick="javascript:details('LOAD2APM_PROG');">Load To APM (<c:out value="${eoFileList.apmLoadFiles}"/>)</a> </span></div>
<div class="uibox uibox_prog"><span class="uiboxtext"><a href="#" onclick="javascript:details('ERROR_FILES');">In Error (<c:out value="${eoFileList.errorFiles}"/>)</a></span></div>
</div>
</td>
</tr>
<tr height="8px"></tr>
...
<div class="uibox uibox_comp"><span class="uiboxtext"><a href="#" onclick="javascript:details('NOT_FOR_PROCESS');">Not For Processing (<c:out value="${eoFileList.noProcessFiles}"/>)</a></span></div>
<div class="uibox uibox_comp"><span class="uiboxtext"><a href="#" onclick="javascript:details('SUCCESS_FILES');">Loaded to APM (<c:out value="${eoFileList.successFiles}"/>)</a></span></div>
</div>
</td>
</tr>
</table>
...
<c:if test="${not empty eoFileList.filterFileStatus}">
<%-- ===================================== NEW FILES ======================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'NEW'}">
<br/>
<table class="contenttable" style="width:1000px;margin:0 auto;border:0px #cccccc solid;" >
<tr>
<td align="left"><h3>New File Review (<c:out value="${eoFileList.newReviewFilesFiltered}"/>)</h3>
</td>
</tr>
</table>
...
<tbody>
<c:if test="${not empty eoFileList.searchResults}">
<c:forEach items="${eoFileList.searchResults}" var="eoFile" varStatus="currentIndexId">
<c:choose>
...
<%-- ===================================== CHANNEL FILES =========================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'CHANNELS'}">
<br/>
<table class="contenttable" style="width:1000px;margin:0 auto;border:0px #cccccc solid;" >
<tr>
<td align="left">
<h3>
Channel Review (<c:out value="${eoFileList.channelReviewFiles}"/>)
</h3>
</td>
</tr>
</table>
...
<%-- ===================================== LOAD 2 APM PEND  ======================================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'LOAD2APM_PEND'}">
...
<td align="left">
<h3>
Load to APM (<c:out value="${eoFileList.rolllupReviewFiles}"/>)
</h3>
</td>
</tr>
</table>
...
<%-- ===================================== LOAD 2 EO PEND  ======================================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'LOAD2EO_PEND'}">
<br/>
<table class="contenttable" style="width:1000px;margin:0 auto;border:0px #cccccc solid;" >
<tr>
<td align="left">
<h3>
Load To EO DB (<c:out value="${eoFileList.eoLoadFiles}"/>)
</h3>
</td>
</tr>
</table>
...
<%-- ===================================== LOAD 2 APM PROG  ======================================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'LOAD2APM_PROG'}">
<br/>
<table class="contenttable" style="width:1000px;margin:0 auto;border:0px #cccccc solid;" >
<tr>
<td align="left">
<h3>
Load To APM (<c:out value="${eoFileList.apmLoadFiles}"/>)
</h3>
</td>
</tr>
</table>
...
<%-- ===================================== ERROR_FILES  ======================================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'ERROR_FILES'}">
...
<td align="left">
<h3>
In Error (<c:out value="${eoFileList.errorFiles}"/>)
</h3>
</td>
</tr>
</table>
...
<%-- ===================================== NOT_FOR_PROCESS  ======================================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'NOT_FOR_PROCESS'}">
...
<td align="left">
<h3>
Not For Processing (<c:out value="${eoFileList.noProcessFiles}"/>)
</h3>
</td>
</tr>
</table>
...
<%-- ===================================== SUCCESS_FILES ======================================================================================================================================================== --%>
<c:if test="${eoFileList.filterFileStatus eq 'SUCCESS_FILES'}">
...
<td align="left">
<h3>
Loaded to APM (<c:out value="${eoFileList.successFilesByPeriod}"/>)
</h3>
</td>
</tr>
</table>
