...
<A class="infolink" href="<%= request.getContextPath() %>/usage/usageHomeSearch?navigationType=BACK2SEARCH">Search Criteria</A><BR>
<A class="infolink" href="<%= request.getContextPath() %>/usage/usageHomeSearch?backToSearchResults=true">Search Results</A>
</td>
</tr>
