...
dragtable = {
  ...
  makeDraggable: function(table) {
	...
	//	alert('dragtable.cookiesEnabled() ' + dragtable.cookiesEnabled() 			+ '; table.id ' + table.id			+ '; table.className ' + table.className		);
...
//		alert('dragObj.table.id:' + dragObj.table.id+ ' dragObj.startCol:' + dragObj.startCol + ' targetCol:'+ targetCol);			
