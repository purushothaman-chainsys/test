...
import com.ascap.apm.common.utils.constants.DistributionConstants;
...
public class UsageDAOImpl extends BaseDAO implements UsageDAO {
    ...
    public static final String APM_WRK_PERF_ID = "APM_WRK_PERF_ID";
    
    public static final String GENERATED_QRY = "Generated Dynamic SQL Query :";
    
    public static final String ERROR_BATCH_SQL_SQLEXCEPTION = "error.usage.batch.sql.sqlexception";
    
    public static final String FINALDEBUG_SQL = "FINAL DEBUG SQL :";
    
    public static final String UPD_ID = ", UPD_ID = ? ";
    
    public static final String VALUES = " VALUES(";
    
    public static final String SUPPCODE = ", SUPP_CODE";
    
    public static final String UPPER_QNMRK = ", UPPER(?)";
    
    public static final String UPPER_OPEN_BRCT = ", UPPER('";
    
    public static final String CRE_DT = ", CRE_DT";
    
    public static final String PFR_NA_COMMA = ", PFR_NA";
    
    public static final String CRE_ID = ", CRE_ID";
    
    public static final String COMMA_TGTSURVYEARQTR = ", TGTSURVYEARQTR";
    
    public static final String EXECUTING_QUERY = "Executing Query : ";
    
    public static final String COMMA_SYSDATE = ", SYSDATE";
    
    public static final String SuppCode = "SuppCode";
    
    public static final String  WRK_ID_QNMRK = ", WRK_ID = ? ";
    
    public static final String COMMA_APM_MATCH_TYP = ", APM_MATCH_TYP = ? ";
    
    public static final String COMMA_WRK_TTL = ", WRK_TTL";
    
    public static final String COMMA_WRK_ID = ", WRK_ID";
    
    public static final String COMMA_WRITER = ", WRITER";
    
    public static final String COMMA_DEL_FL = ", DEL_FL";
    
    public static final String COMMA_N = ", 'N'";
    
    public static final String AND_SUPP_CODE = " AND A.SUPP_CODE = ? ";
    
    public static final String AND_WRK_TTL = " AND A.WRK_TTL = ? ";

    public static final String AND_WRK_TTL_NULL = " AND A.WRK_TTL IS NULL ";

    public static final String AND_PFR_NA = " AND A.PFR_NA = ? ";

    public static final String AND_WRITER = " AND A.WRITER = ? ";

    public static final String AND_WRITER_NULL = " AND A.WRITER IS NULL ";
    
    public static final String WRK_TTL = "WRK_TTL";
    
    public static final String WRK_ID = "WRK_ID";
    
    public static final String USE_TYP = "USE_TYP";
    
    public static final String WRK_PERF_DUR = "WRK_PERF_DUR";
    
    public static final String PLAY_CNT = "PLAY_CNT";
    ...
    public static final String INPUT_COLLECTION = "Input Collection is null.. Returning.. null";
    
    public static final String AND_SUPP_CODE_QNMRK = " AND SUPP_CODE = ? ";
    
    public static final String APMREQUEST = "apmRequest::::::::::::::";
    
    public static final String  AND_SUPP_CODE_NULL = " AND SUPP_CODE IS NULL ";
    ...
    private void moveWorkPerformances(PerformanceSearch performanceSearch) throws PrepSystemException {
        ...
        try {
            ...
            throw new PrepSystemException(ERROR_BATCH_SQL_SQLEXCEPTION, se);
    ...
    public void callPerformanceBatchValidate(String actionType, String perfHeaderId, String workPerfId, String userId)
        ...
        try {
            ...
            params.add(userId);
            ascapJdbcTemplate.update(UsageQueries.BATCH_APM_PERF_VALIDATE, params.toArray());
        } catch (Exception se) {
            log.debug(se);
            throw new PrepSystemException(ERROR_BATCH_SQL_SQLEXCEPTION, se);
    ...
    public PerformanceSearch searchWorkPerformances(PerformanceSearch performanceSearchCriteria)
        ...
        List<Object> profileMessagesList = new ArrayList<>();
    ...
    public PerformanceSearch searchProgramPerformances(PerformanceSearch performanceSearchCriteria)
        ...
        ArrayList<Object> profileMessagesList = new ArrayList<>();
        if (log.isDebugEnabled()) {
    ...
    private ProgramPerformance updateBasicProgramPerformance(ProgramPerformance programPerformanceVob)
        throws PrepSystemException {
        String sysdate = " SET UPD_DT = SYSDATE ";
        log.debug(
        ...
        try {
            ...
            updateProgramPerformanceColumnsPart.append(sysdate);

            if (log.isDebugEnabled()) {
                debugUpdateProgramPerformanceSqlColumnsPart.append(sysdate);
            }
            ...
            if (log.isDebugEnabled()) {
                log.debug(GENERATED_QRY + updateProgramPerformanceSqlStr);
                ...
                log.debug(FINALDEBUG_SQL + debugFinalUpdateProgramPerformanceSql.toString());
            }
    ...
    private ProgramPerformance createBasicProgramPerformance(ProgramPerformance programPerformanceVob)
        ...
        try {
            programPerformanceHeaderId = this.getSequence(UsageQueries.SEQUENCE_PERF_HDR_ID, ascapJdbcTemplate);
            ...
            if (!UsageCommonValidations.isEmptyOrNull(programPerformanceVob.getMusicUserId())) {
                insertProgramPerformanceColumnsPart.append(ptyId);
                insertProgramPerformanceValuesPart.append(", ?");
                programPerformanceValuesList.add(programPerformanceVob.getMusicUserId());
                if (log.isDebugEnabled()) {
                    debugInsertProgramPerformanceSqlColumnsPart.append(ptyId);
                    debugInsertProgramPerformanceSqlValuesPart.append(", '")
                        .append(programPerformanceVob.getMusicUserId()).append("'");
                }
            }
            ...
            if (!UsageCommonValidations.isEmptyOrNull(programPerformanceVob.getSupplierCode())) {
                insertProgramPerformanceColumnsPart.append(SUPPCODE);
                insertProgramPerformanceValuesPart.append(", ?");
                programPerformanceValuesList.add(programPerformanceVob.getSupplierCode());
                if (log.isDebugEnabled()) {
                    debugInsertProgramPerformanceSqlColumnsPart.append(SUPPCODE);
                    debugInsertProgramPerformanceSqlValuesPart.append(", '")
                        .append(programPerformanceVob.getSupplierCode()).append("'");
                }
            }
            ...
            if (!UsageCommonValidations.isEmptyOrNull(programPerformanceVob.getProgramTitle())) {
                ...
                insertProgramPerformanceValuesPart.append(UPPER_QNMRK);
                programPerformanceValuesList.add(programPerformanceVob.getProgramTitle());
                if (log.isDebugEnabled()) {
                    debugInsertProgramPerformanceSqlColumnsPart.append(", PGM_TTL");
                    debugInsertProgramPerformanceSqlValuesPart.append(UPPER_OPEN_BRCT)
                        .append(programPerformanceVob.getProgramTitle()).append("')");
                }
            }
            ...
            if (!UsageCommonValidations.isEmptyOrNull(programPerformanceVob.getPerformerName())) {
                insertProgramPerformanceColumnsPart.append(PFR_NA_COMMA);
                insertProgramPerformanceValuesPart.append(UPPER_QNMRK);
                programPerformanceValuesList.add(programPerformanceVob.getPerformerName());
                if (log.isDebugEnabled()) {
                    debugInsertProgramPerformanceSqlColumnsPart.append(PFR_NA_COMMA);
                    debugInsertProgramPerformanceSqlValuesPart.append(UPPER_OPEN_BRCT)
            ...
            if (!UsageCommonValidations.isEmptyOrNull(programPerformanceVob.getTargetYearQuarter())) {
                insertProgramPerformanceColumnsPart.append(COMMA_TGTSURVYEARQTR);
                insertProgramPerformanceValuesPart.append(", ?");
                programPerformanceValuesList.add(programPerformanceVob.getTargetYearQuarter());
                if (log.isDebugEnabled()) {
                    debugInsertProgramPerformanceSqlColumnsPart.append(COMMA_TGTSURVYEARQTR);
                    debugInsertProgramPerformanceSqlValuesPart.append(", '")
                        .append(programPerformanceVob.getTargetYearQuarter()).append("'");
                }
            }
            ...
            insertProgramPerformanceValuesPart.append(COMMA_SYSDATE);
            ...
            if (log.isDebugEnabled()) {
                log.debug(GENERATED_QRY + insertProgramPerformanceSqlStr);
                ...
                log.debug(FINALDEBUG_SQL + debugFinalInsertProgramPerformanceSql.toString());
            }
    ...
    public ApmChannelList getChannelList(ApmChannelList apmChannelList) throws PrepSystemException {
        ...
        try {
            ...
            log.debug(EXECUTING_QUERY + sb.toString());
    ...
    public ApmChannelList updateChannelList(ApmChannelList apmChannelList) throws PrepSystemException {
        ...
        try {
            ...
            if ("ASSIGN".equals(apmChannelList.getOperationType())) {
                ...
                params.add("Y");
                params.add(apmChannelList.getUserId());
                params.add(apmChannelList.getFilterSupplierCode());
    ...
    private WorkPerformance updateBasicWorkPerformance(WorkPerformance workPerformanceVob) throws PrepSystemException {
        ...
        try {
            ...
            updateWorkPerformanceColumnsPart.append(sysdate);

            debugUpdateWorkPerformanceSqlColumnsPart.append(sysdate);
            ...
            updateWorkPerformanceColumnsPart.append(WRK_ID_QNMRK);
            ...
            updateWorkPerformanceColumnsPart.append(COMMA_APM_MATCH_TYP);
            ...
            log.debug(GENERATED_QRY + updateWorkPerformanceSqlStr);
            ...
            log.debug(FINALDEBUG_SQL + debugFinalUpdateWorkPerformanceSql.toString());
        ...
        try {
            ...
            if (sequenceRs != null) {
                if (!sequenceRs.isAfterLast() && !sequenceRs.isBeforeFirst()) {
                    ...
                    while (sequenceRs.next()) {
                        log.debug("DAO Returning: " + sequenceRs.getString(1));
    ...
    private WorkPerformance createBasicWorkPerformance(WorkPerformance workPerformanceVob) throws PrepSystemException {
        ...
        try {
            workPerformanceId = this.getSequence(UsageQueries.SEQUENCE_WRK_PERF_ID, ascapJdbcTemplate);
            ...
            if (!UsageCommonValidations.isEmptyOrNull(workPerformanceVob.getWorkTitle())) {
                insertWorkPerformanceColumnsPart.append(COMMA_WRK_TTL);
                insertWorkPerformanceValuesPart.append(", ?");
                workPerformanceValuesList.add(workPerformanceVob.getWorkTitle());
            ...
            if (!UsageCommonValidations.isEmptyOrNull(workPerformanceVob.getWorkId())) {
                insertWorkPerformanceColumnsPart.append(COMMA_WRK_ID);
                insertWorkPerformanceValuesPart.append(", ?");
                workPerformanceValuesList.add(workPerformanceVob.getWorkId());
            ...
            if (!UsageCommonValidations.isEmptyOrNull(workPerformanceVob.getPerformerName())) {
                insertWorkPerformanceColumnsPart.append(PFR_NA_COMMA);
                insertWorkPerformanceValuesPart.append(UPPER_QNMRK);
                workPerformanceValuesList.add(workPerformanceVob.getPerformerName());
                debugInsertWorkPerformanceSqlValuesPart.append(UPPER_OPEN_BRCT)
                    .append(workPerformanceVob.getPerformerName()).append("')");
            }
            ...
            if (!UsageCommonValidations.isEmptyOrNull(workPerformanceVob.getTargetYearQuarter())) {
                insertWorkPerformanceColumnsPart.append(COMMA_TGTSURVYEARQTR);
                insertWorkPerformanceValuesPart.append(", ?");
            ...
            if (!UsageCommonValidations.isEmptyOrNull(workPerformanceVob.getWriter())) {
                insertWorkPerformanceColumnsPart.append(COMMA_WRITER);
                insertWorkPerformanceValuesPart.append(", ?");
                workPerformanceValuesList.add(workPerformanceVob.getWriter());
            ...
            insertWorkPerformanceColumnsPart.append(SUPPCODE);
            ...
            insertWorkPerformanceColumnsPart.append(COMMA_DEL_FL);
            insertWorkPerformanceValuesPart.append(COMMA_N);

            insertWorkPerformanceColumnsPart.append(CRE_DT);
            insertWorkPerformanceValuesPart.append(COMMA_SYSDATE);
            ...
            log.debug(GENERATED_QRY + insertWorkPerformanceSqlStr);
            ...
            log.debug(FINALDEBUG_SQL + debugFinalInsertWorkPerformanceSql.toString());
    ...
    public List<Object> validateWorkIdForBulkMatch(ApmPerformanceBulkRequest apmPerformanceBulkRequestList)
        ...
        try {
            ...
            if (!ValidationUtils.isValidLong(apmPerformanceBulkRequestList.getWorkId())) {
                col.add(workId + apmPerformanceBulkRequestList.getWorkId() + " must be Numeric");
            } else {
                ...
                if (rs.next()) {
                    if ("INF".equals(rs.getString("WRK_TYP_CDE"))) {
                        col.add(workId + apmPerformanceBulkRequestList.getWorkId() + " is an Informational Work");
                    }
                    if ("Y".equals(rs.getString("PUB_DOM_IND"))) {
                        col.add(workId + apmPerformanceBulkRequestList.getWorkId() + " is a Public Domain Work");
                    }

                    if (0 == rs.getInt("WRK_GRD_VAL")) {
                        col.add(workId + apmPerformanceBulkRequestList.getWorkId()
                            + " Copyright Arrangement Percentage of the Work is not Available");
                    }
                } else {
                    col.add(workId + apmPerformanceBulkRequestList.getWorkId() + " is not a valid Work ID");
                }
            }
    ...
    private ApmPerformanceBulkRequest updateCatalogManualMatch(ApmPerformanceBulkRequest apmPerformanceBulkRequest) {
        ...
        if (UsageConstants.BULK_REQUEST_TYPE_UPDATE.equals(apmPerformanceBulkRequest.getRequestTypeCode())) {
            ...
            valuesList.add(apmPerformanceBulkRequest.getUserId());
            columnsPart.append(WRK_ID_QNMRK);
            valuesList.add(apmPerformanceBulkRequest.getWorkId());
            columnsPart.append(COMMA_APM_MATCH_TYP);
            valuesList.add("MAN");
        ...
        if (!ValidationUtils.isEmptyOrNull(apmPerformanceBulkRequest.getSupplierCode())) {
            columnsPart.append(AND_SUPP_CODE_QNMRK);
        ...
        try {
            ...
            log.debug(GENERATED_QRY + sqlStr.toString());
            int totalParameters;
            ...
            while (itr.hasNext()) {
                ...
                if (UsageConstants.APM_LEARNED_MATCH_TYPE_PERFORMER.equals(matchType)) {
                    ...
                    if (!supplierIsNull.equalsIgnoreCase("Y")) {
                        ...
                        if (learnedDeleteExists.equalsIgnoreCase("Y")) {
                            updateQuery =
                                new StringBuilder(UsageQueries.UNDELETE_LEARNED_MATCH + AND_SUPP_CODE_QNMRK);
                        }
                        // LM entry does not exists
                        else
                            updateQuery =
                                new StringBuilder(UsageQueries.UNDELETE_LEARNED_MATCH + AND_SUPP_CODE_NULL);
                    }
                ...
                // title / writer combination condition
                    ...
                    if (!supplierIsNull.equalsIgnoreCase("Y")) {
                        ...
                        if (learnedDeleteExists.equalsIgnoreCase("Y")) {
                            updateQuery =
                                new StringBuilder(UsageQueries.UNDELETE_LEARNED_MATCH_WTR + AND_SUPP_CODE_QNMRK);
                        }
                        // LM entry does not exists
                        else
                            updateQuery =
                                new StringBuilder(UsageQueries.UNDELETE_LEARNED_MATCH_WTR + AND_SUPP_CODE_NULL);
                    }
                    // supplier does not exists
                    else {
                        learnedDeleteExists =
    ...
    private String learnedDeleteExists(String title, String artist, String writerMatching) throws PrepSystemException {
        ...
        String result = "";
        String sql = UsageQueries.LEARNED_DEL_EXISTS + AND_SUPP_CODE_NULL;
        if (writerMatching.equalsIgnoreCase("Y")) {
            sql = UsageQueries.LEARNED_DEL_EXISTS_WTR + AND_SUPP_CODE_NULL;
        }
    ...
    private String learnedDeleteExists(String supplier, String title, String artist, String writerMatching)
        ...
        log.debug("Entering  UsageDAOImpl - learnedDeleteExists method ");
        String result = "";
        String sql = UsageQueries.LEARNED_DEL_EXISTS + AND_SUPP_CODE_QNMRK;

        if (writerMatching.equalsIgnoreCase("Y")) {
            sql = UsageQueries.LEARNED_DEL_EXISTS_WTR + AND_SUPP_CODE_QNMRK;
        }
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (count <= 0) {
                    ...
                    if ("UPD".equals(apmPerformanceBulkRequestList.getRequestTypeCode())) {
                        ...
                        if (ValidationUtils.isEmptyOrNull(apmRequest.getSupplierCode())) {
                            updateQuery.append(AND_SUPP_CODE_NULL);
                        } else {
                            updateQuery.append(AND_SUPP_CODE_QNMRK);
                        }
                        ArrayList<Object> params = new ArrayList<>();
                        params.add(apmRequest.getUserId());
                        params.add(performerOrWriterValue);
    ...
    public ApmPerformanceBulkRequestList cloneCatalogPerformances(
        ...
        try {
            ...
            if (ValidationUtils.isEmptyOrNull(multiWorkId) && numMedleyWorks > 1) {
                multiWorkId = this.getSequence("SELECT PAPM.MULT_WRK_ID.NEXTVAL FROM DUAL", ascapJdbcTemplate);
    ...
    private void addNewCatalogClonedWorkPerforance(List<WorkPerformance> wpList, String multiWorkId)
        ...
        try {
            ...
            log.debug("Exiting private addNewCatalogClonedWorkPerforance in UsageDAOImpl");
        }
    }
    ...
    private ApmPerformanceBulkRequestList updateMedleyLeanredMatch(
        ...
        throws PrepSystemException {
        log.debug("Entering updateMedleyLeanredMatch in UsageDAOImpl");
        ...
        try {
            if (!ValidationUtils.isEmptyOrNull(supplierCode)) {
                qry += AND_SUPP_CODE_QNMRK;
            } else {
                qry += AND_SUPP_CODE_NULL;
            }
            ArrayList<Object> params = new ArrayList<>();
            params.add(apmPerformanceBulkRequestList.getUserId());
            params.add(multiWorkId);
    ...
    private ApmPerformanceBulkRequest addApmPerfBulkRequest(ApmPerformanceBulkRequest apmPerformanceBulkRequest)
        ...
        log.debug("Entering private addApmPerfBulkRequest in UsageDAOImpl");
        StringBuilder sqlStr = null;
        ...
        try {
            ...
            log.debug("Exiting private addApmPerfBulkRequest in UsageDAOImpl");
        }
        return apmPerformanceBulkRequest;
    }

    public String getSumRollupCnt(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getSumRollupCnt method ");
        ...
        log.debug("Exiting  UsageDAOImpl - getSumRollupCnt method ");

        return (result);
    }

    public EOFile getEOBatchControl(EOFile eoFile) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getEOBatchControl method ");
        ...
        log.debug("Exiting  UsageDAOImpl - getEOBatchControl method ");
        return eoFile;
    }

    public String validationErrorExists(String suppcode, String perfqtr) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - validationErrorExists method ");
        ...
        log.debug("Exiting  UsageDAOImpl - validationErrorExists method ");

        return (result);
    }

    public String getSupplierType(String suppcode) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - isCatalogSupplier method ");
        ...
        log.debug("Exiting  UsageDAOImpl - isCatalogSupplier method ");
    ...
    public List<EOSupplierFormat> getApmSuppliers() throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - getApmSuppliers");
        ...
        log.debug("Exiting UsageDAOImpl - getApmSuppliers");
    ...
    public ApmActiveSurveyQuarter getApmActiveSurveyQuarter() throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - getApmActiveSurveyQuarter");
    ...
    public EOFileList getEOFileList(EOFileList eoFileList) throws PrepSystemException {
        ...
        log.debug("Exiting UsageDAOImpl - getEOFileList method ");

        return eoFileList;
    }

    public EOFileList getEOFileListDetails(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getEOFileListDetails method ");
        ...
        log.debug("Exiting UsageDAOImpl - getEOFileListDetails method ");

        return eoFileList;
    }

    private EOFileList getUnassingedChannelSuppliers(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getUnassingedChannelSuppliers method ");
        ...
        log.debug("Exiting UsageDAOImpl - getUnassingedChannelSuppliers method ");

        return eoFileList;
    }

    private EOFileList getLoadToApmFiles(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getLoadToApmFiles method ");
        ...
        log.debug("Exiting UsageDAOImpl - getLoadToApmFiles method ");

        return eoFileList;
    }

    private EOFileList getLoadToApmFilesInProgress(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getLoadToApmFilesInProgress method ");
        ...
        log.debug("Exiting UsageDAOImpl - getLoadToApmFilesInProgress method ");

        return eoFileList;
    }

    private EOFileList getFilesInError(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getFilesInError method ");
        ...
        log.debug("Exiting UsageDAOImpl - getFilesInError method ");

        return eoFileList;
    }

    private EOFileList getFilesNotForProcess(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getFilesNotForProcess method ");
    ...
    private EOFileList getFilesInCompleted(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getFilesInCompleted method ");
        ...
        log.debug("Exiting UsageDAOImpl - getFilesInCompleted method ");

        return eoFileList;
    }

    private EOFileList getLoadToEoFiles(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - getLoadToEoFiles method ");
        ...
        log.debug("Exiting UsageDAOImpl - getLoadToEoFiles method ");
    ...
    private EOFileList getNewEOFiles(EOFileList eoFileList) throws PrepSystemException {
        log.debug(
            "Entering  UsageDAOImpl - getNewEOFiles method Filter Supplier: " + eoFileList.getFilterSupplierCode());
        ...
        log.debug("Exiting UsageDAOImpl - getNewEOFiles method ");
    ...
    public EOFileList loadToAPM(EOFileList eoFileList) throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - loadToAPM method ");
        ...
        log.debug("Exiting  UsageDAOImpl - loadToAPM method ");
        return eoFileList;
    }
    ...
    public String getRollupThreshold() throws PrepSystemException {
        ...
        log.debug("Entering getRollupThreshold method in UsageDAOImpl ");
        String result = null;
        SqlRowSet rs = null;
        try {
        ...
        log.debug("Exiting getRollupThreshold method in UsageDAOImpl ");
    ...
    public EOFileList updateFileInventory(EOFileList eoFileList) throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - updateFileInventory method ");
        ...
        log.debug("Exiting  UsageDAOImpl - updateFileInventory method ");
        return eoFileList;
    }

    public EOFileList loadToEO(EOFileList eoFileList) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - loadToEO method ");
        ...
        log.debug("Exiting  UsageDAOImpl - loadToEO method ");
        return eoFileList;
    }

    private boolean isSupplierFormatExists(EOFile eoFile) throws PrepSystemException {
        log.debug("Entering  UsageDAOImpl - isSupplierFormatExists method ");
        ...
        log.debug("Exiting  UsageDAOImpl - isSupplierFormatExists method ");
    ...
    public LogRequestSummary getLogRequestSummary(LogRequestSummary logRequestSummary) throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - getLogRequestSummary method ");
        ...
        log.debug("Exiting UsageDAOImpl - getLogRequestSummary method ");
    ...
    public int getTotalSearchRows(LogRequestSummary logRequestSummary) throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - getTotalSearchRows method ");
        ...
        log.debug("Exiting UsageDAOImpl - getTotalSearchRows method ");
    ...
    public LogRequestSummary updateLogRequestSummary(LogRequestSummary logRequestSummary) throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - updateLogRequestSummary method ");
    ...
    private void updateLogRequestHdr(String[] selections) throws PrepSystemException {
        ...
        log.debug("Entering  UsageDAOImpl - updateLogRequestHdr method ");
        ...
        log.debug("Exiting  UsageDAOImpl - updateLogRequestHdr method ");
    }

    private void deleteLogRequestHdr(String filterTargetSurveyYearQuarter) throws PrepSystemException {

        log.debug("Entering  UsageDAOImpl - deleteLogRequestHdr method ");
        ...
        log.debug("Exiting  UsageDAOImpl - deleteLogRequestHdr method ");
    }

    private void releaseLogRequest(String[] selections) throws PrepSystemException {

        log.debug("Entering  UsageDAOImpl - releaseLogRequest method ");
        ...
        log.debug("Exiting  UsageDAOImpl - releaseLogRequest method ");
    }
    ...
    public ApmFileList seacrhFiles(ApmFileList apmFileList) throws PrepSystemException {
        log.debug("Entering UsageDAOImpl - seacrhFiles method " + apmFileList);
        ...
        if (!UsageCommonValidations.isEmptyOrNull(apmFileList.getSupplierCode())) {
            searchFileWherePartDistribution.append(AND_SUPP_CODE);
        ...
        if (!UsageCommonValidations.isEmptyOrNull(apmFileList.getFileType())) {
    ...
    public LogUsageSummary getLogUsageSummary(LogUsageSummary logUsageSummary) throws PrepSystemException {
        ...
        try {
            ...
            log.debug(EXECUTING_QUERY + strb.toString());
    ...
    public Exemption addExemption(Exemption exemption) throws PrepSystemException {
        ...
        try {
            exemptionSequenceId = this.getSequence(UsageQueries.SEQUENCE_SM_DEDUP_EXEMPTIONS_ID, ascapJdbcTemplate);
            ...
            if (!UsageCommonValidations.isEmptyOrNull(exemption.getExemptionType())) {
                if ("PTY_ID".equals(exemption.getExemptionType())) {
                    ...
                    columnsPart.append(COMMA_WRK_ID);
                    valuesPart.append(", ?");
                    valuesList.add(exemption.getExemptionValue());
                    ...
                    columnsPart.append(COMMA_WRK_TTL);
                    valuesPart.append(", ?");
                    ...
                    columnsPart.append(COMMA_WRITER);
                    valuesPart.append(", ?");
                    formattedStr = "%" + exemption.getExemptionValue().replaceAll("\\s+", "%") + "%";
                    valuesList.add(formattedStr);
                }
            ...
            columnsPart.append(COMMA_DEL_FL);
            valuesPart.append(COMMA_N);
            columnsPart.append(CRE_DT);
            valuesPart.append(COMMA_SYSDATE);
            columnsPart.append(") ");
            valuesPart.append(") ");
    ...
    private void callSamplingBatchRequest(JdbcTemplate ascapJdbcTemplate, String requestId, String stepCode)
        ...
        try {
            ...
            log.debug(e);
            throw new PrepSystemException(ERROR_BATCH_SQL_SQLEXCEPTION, e);
        }
    ...
    private String validateHeaderForUndelete(String groupId, String userId) throws PrepSystemException {
        ...
        log.debug("Entering UsageDAOImpl - validateHeaderForUndelete");
        log.debug("groupId : " + groupId);
        log.debug("userId : " + userId);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                pfrNa = rs.getString("pfr_na");
                wrkTtl = rs.getString("wrk_ttl");
                writer = rs.getString("writer");

                if (!UsageCommonValidations.isEmptyOrNull(suppCode)) {
                    sql = sql + " and SUPP_CODE = ? ";
                }
                if (!UsageCommonValidations.isEmptyOrNull(writer)) {
                    sql = sql + " and WRITER = ? ";
                }
                if (!UsageCommonValidations.isEmptyOrNull(wrkTtl)) {
                    sql = sql + " and WRK_TTL = ? ";
                } else {
                    sql = sql + " AND WRK_TTL  IS NULL ";
                }
                if (!UsageCommonValidations.isEmptyOrNull(pfrNa)) {
                    sql = sql + " and PFR_NA = ? ";
                } else {
    ...
    private void addNewClonedWorkPerforance(String activeSurveyYearQuarter, List<WorkPerformance> wpList,
        ...
        log.debug("Entering private addNewClonedWorkPerforance with List in UsageDAOImpl");
    ...
    public EOLearnedMatchList deleteEOLearnedMatchList(EOLearnedMatchList eoLearnedMatchList)
        ...
        if (eoLearnedMatchList == null
            || UsageCommonValidations.isEmptyOrNull(eoLearnedMatchList.getEoLearnedMatchType())) {
            log.debug("Invalid input object or invalid match type to determine lm type");
            return eoLearnedMatchList;
        }
        if (eoLearnedMatchList == null
            || (eoLearnedMatchList.getMultWorkId() == null && eoLearnedMatchList.getSelectedIndex() == null)) {
        ...
        try {
            ...
            if (!UsageCommonValidations.isEmptyOrNull(eoLearnedMatchList.getEoLearnedMatchType())) {
                ...
                sqlStr = new StringBuilder("UPDATE " + sqlTableName
                    + " SET DELFLAG = 'Y',  UpdID= ?, UpdDt =  GetDate() WHERE ID = ? and DelFlag = 'N' ");
            }
            ...
            if (eoLearnedMatchList.getMultWorkId() != null && eoLearnedMatchList.getMultWorkId().length > 0) {
                if ("URL".equals(eoLearnedMatchList.getEoLearnedMatchType())) {
                    sqlStr = new StringBuilder(
                        "UPDATE IDMatching.dbo.LearnedMatchUrl SET DELFLAG = 'Y',  UpdID= ?, UpdDt =  GetDate() WHERE multWrkId = ? and DelFlag = 'N' ");
                } else {
                    sqlStr = new StringBuilder(
                        "UPDATE IDMatching.dbo.LearnedMatchSuppId SET DELFLAG = 'Y',  UpdID= ?, UpdDt =  GetDate() WHERE mult_Wrk_Id = ? and DelFlag = 'N' ");
                }
    ...
    public EOLearnedMatchList getEOLearnedMatchList(EOLearnedMatchList eoLearnedMatchList) throws PrepSystemException {
        log.debug("Entering getEOLearnedMatchList in UsageDAOImpl");
        ...
        try {
            ...
            if (!ValidationUtils.isEmptyOrNull(eoLearnedMatchList.getFilterSupplierCode())
                && "SUPPLIERID".equals(eoLearnedMatchList.getFilterMatchTypeCode())) {
                qry.append(" AND suppcode = ? ");
                params.add(eoLearnedMatchList.getFilterSupplierCode());
            }

            if (!ValidationUtils.isEmptyOrNull(eoLearnedMatchList.getFilterMultWorkId())
                && "SUPPLIERID".equals(eoLearnedMatchList.getFilterMatchTypeCode())) {
            ...
            if (eoLearnedMatchList.getNavigationType() == null) {
                ...
                if (eoLearnedMatchList.getNumberOfRecordsFound() <= 0
                    && eoLearnedMatchList.getCurrentPageNumber() > 1) {
        ...
        log.debug("Exiting getEOLearnedMatchList in UsageDAOImpl");
        return eoLearnedMatchList;
    ...
    public List<ApmWork> validateApmWorks(List<ApmWork> col) throws PrepSystemException {
        ...
        log.debug("Entering validateApmWorks method in UsageDAOImpl ");
    ...
    public EOLearnedMatchList updateEOLearnedMatchList(EOLearnedMatchList eoLearnedMatchList)
        ...
        if (eoLearnedMatchList == null || eoLearnedMatchList.getSearchResults() == null
            || eoLearnedMatchList.getSearchResults().size() < 1) {
            log.debug("Invalid Input .. Returning");
            return eoLearnedMatchList;
        }
        ...
        log.debug("Exiting updateEOLearnedMatchList in UsageDAOImpl");
        return eoLearnedMatchList;
    }
    ...
    public EOLearnedMatch getEOLearnedMatchMedleyWorkInformation(EOLearnedMatchList eoLearnedMatchList)
        ...
        try {
            ...
            if (!ValidationUtils.isEmptyOrNull(eoLearnedMatchList.getMultWorkMultWorkId())) {
                ...
                String qry =
                    " SELECT ID, URL, WrkId, MultWrkId, null SupplierCode, null cloneCnt FROM IDMatching.dbo.LearnedMatchUrl where MultWrkId = ? and DelFlag = 'N' ";

                if ("SUPPLIERID".equals(eoLearnedMatchList.getEoLearnedMatchType())) {
                    qry =
                        " SELECT ID, suppsongid as url, WrkId, Mult_Wrk_Id as MultWrkId, SuppCode as SupplierCode, coalesce(clone_cnt,1) as cloneCnt FROM IDMatching.dbo.LearnedMatchSuppId where Mult_Wrk_Id = ? and DelFlag = 'N' ";
                }
                log.debug("query:: " + qry);
        ...
        log.debug("Exiting getEOLearnedMatchMedleyWorkInformation in UsageDAOImpl " + eoLearnedMatch);
        return eoLearnedMatch;
    }

    public EOLearnedMatch getEOLearnedMatch(EOLearnedMatch eoLearnedMatch) throws PrepSystemException {
        log.debug("Entering getEOLearnedMatch of UsageDAOImpl EOLearnedMatch :" + eoLearnedMatch);
        ...
        try {
            ...
            if ("URL".equals(eoLearnedMatch.getMatchType())) {
                params.add(eoLearnedMatch.getMatchIdValue().substring(eoLearnedMatch.getMatchIdValue().indexOf("=") + 1)
                    .trim());
            } else {
            ...
            if (!"ISRC".equals(eoLearnedMatch.getMatchType()) && !"ISWC".equals(eoLearnedMatch.getMatchType())
                && !"URL".equals(eoLearnedMatch.getMatchType())) {
        ...
        log.debug("Exiting getEOLearnedMatch of UsageDAOImpl EOLearnedMatch :" + eoLearnedMatch);
        return outEOLearnedMatch;
    }

    public String validateIndustryIds(String idType, String idValue) throws PrepSystemException {
        log.debug("Entering validateIndustryIds method in UsageDAOImpl.. Validating " + idType + " " + idValue);
        String result = null;
        SqlRowSet rs = null;
        try {
        ...
        log.debug("Exiting validateIndustryIds method in UsageDAOImpl " + result);
    ...
    public EOLearnedMatch addEOLearnedMatch(EOLearnedMatch eoLearnedMatch) throws PrepSystemException {
        ...
        log.debug("Entering addEOLearnedMatch of UsageDAOImpl EOLearnedMatch :" + eoLearnedMatch);
        StringBuilder sqlStr = null;
        ...
        try {
            ...
            if ("URL".equals(eoLearnedMatch.getMatchType())) {
                if (eoLearnedMatch.getWorkIds().length > 1) {
                    ...
                    SqlRowSet rs = eoDSJdbcTemplate.queryForRowSet(
                        " SELECT ( MAX( COALESCE(multwrkid, 0)) + 1 ) AS SEQ FROM IDMatching.dbo.LearnedMatchUrl ");
                ...
                if (!UsageCommonValidations.isEmptyOrNull(eoLearnedMatch.getMatchIdValue())) {
                    if (!UsageCommonValidations.isEmptyOrNull(eoLearnedMatch.getMatchType())) {
                        if ("ISRC".equals(eoLearnedMatch.getMatchType())) {
                            ...
                            valuesPart.append(", ?");
                            valuesList.add(eoLearnedMatch.getMatchIdValue()
                                .substring(eoLearnedMatch.getMatchIdValue().indexOf("=") + 1).trim());
                        } else if ("SUPPLIERID".equals(eoLearnedMatch.getMatchType())) {
        ...
        log.debug("Exiting addApmLearnedMatch of UsageDAOImpl");
        return eoLearnedMatch;
    }

    public EOLearnedMatch updateEOLearnedMatchMultiple(EOLearnedMatch eoLearnedMatch) throws PrepSystemException {

        log.debug("Entering updateEOLearnedMatchMultiple method in UsageDAOImpl apmLearnedMatch " + eoLearnedMatch);

        if (eoLearnedMatch == null || eoLearnedMatch.getWorkIdCollection() == null
            || eoLearnedMatch.getWorkIdCollection().size() <= 0) {
        ...
        try {
            ...
            if ("URL".equals(eoLearnedMatch.getMatchType())) {
                ...
                updateSoftDeleteAll = new StringBuilder(
                    "UPDATE IDMatching.dbo.LearnedMatchUrl SET DelFlag = 'Y', UpdId = ?, UpdDt = GETDATE(), multWrkId = NULL WHERE URL = ?  AND DelFlag = 'N' ");
                ...
                updateSoftDeleteAll = new StringBuilder(
                    "UPDATE IDMatching.dbo.LearnedMatchSuppId SET DelFlag = 'Y', UpdId = ?, UpdDt = GETDATE(), mult_Wrk_Id = NULL, clone_cnt = null WHERE suppSongId = ?  AND DelFlag = 'N' AND SuppCode = ?");
                params.add(eoLearnedMatch.getUserId());
                params.add(eoLearnedMatch.getMatchIdValue());
                params.add(eoLearnedMatch.getSupplierCode());
            }
            ...
            if (workIdList.size() > 1 && ValidationUtils.isEmptyOrNull(multWorkId)) {
                log.debug(
                    "Getting sequeence   SELECT ( MAX( COALESCE(multwrkid, 0)) + 1 ) AS SEQ FROM IDMatching.dbo.LearnedMatchUrl ");
                multWorkId = this.getSequence(
                    " SELECT ( MAX( COALESCE(multwrkid, 0)) + 1 ) AS SEQ FROM IDMatching.dbo.LearnedMatchUrl ",
                    eoDSJdbcTemplate);
                ...
                if (updCount <= 0) {
                    ...
                    if ("URL".equals(eoLearnedMatch.getMatchType())) {
                        ...
                        insertQry = new StringBuilder(
                            " INSERT INTO IDMatching.dbo.LearnedMatchUrl (DelFlag, CreDt, URL, WrkId, MatchType, CreID,  MultWrkId) VALUES ('N', GETDATE(), ?,?,?,?,?) ");
                        ...
                        insertQry = new StringBuilder(
                            " INSERT INTO IDMatching.dbo.LearnedMatchSuppId (DelFlag, CreDt, SuppSongId, WrkId, MatchType, CreID,  Mult_Wrk_Id, SuppCode, clone_cnt) VALUES ('N', GETDATE(), ?,?,?,?,?,?, ?) ");
        ...
        log.debug("Exiting updateEOLearnedMatchMultiple method in UsageDAOImpl eoLearnedMatch " + eoLearnedMatch);
        return eoLearnedMatch;
    }
    ...
    public ApmLearnedMatch getApmLearnedMatch(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering getApmLearnedMatch method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);

        List<String> searchValuesList = new ArrayList<>();
        StringBuilder sb = null;
        if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getPerformerName())) {
            sb = new StringBuilder(UsageQueries.GET_APM_LEARNED_MATCH_START);
        } else {
            sb = new StringBuilder(UsageQueries.GET_APM_LEARNED_MATCH_WTR_START);
        }
        ApmLearnedMatch outApmLearnedMatch = null;
        if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
            sb.append(AND_SUPP_CODE);
            searchValuesList.add(apmLearnedMatch.getSupplierCode());
        } else {
            sb.append(" AND A.SUPP_CODE IS NULL ");
        }
        if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getWorkTitle())) {
            sb.append(AND_WRK_TTL);
            searchValuesList.add(apmLearnedMatch.getWorkTitle());
        } else {
            sb.append(AND_WRK_TTL_NULL);
        }
        ...
        if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getPerformerName())) {
            sb.append(AND_PFR_NA);
            searchValuesList.add(apmLearnedMatch.getPerformerName());
        } else if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getWriterName())) {
            sb.append(AND_WRITER);
            searchValuesList.add(apmLearnedMatch.getWriterName());
        }

        if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getWorkId())
            && UsageConstants.APM_LEARNED_MATCH_REQ_TYP_GET.equals(apmLearnedMatch.getRequestId())) {
            sb.append(" AND A.WRK_ID = ? ");
            searchValuesList.add(apmLearnedMatch.getWorkId());
        }
        sb.append(" ORDER BY DEL_FL ");
        try {
            log.debug(EXECUTING_QUERY + sb.toString());
            SqlRowSet rs = ascapJdbcTemplate.queryForRowSet(sb.toString(), searchValuesList.toArray());
            if (rs.next()) {
                outApmLearnedMatch = new ApmLearnedMatch();
                outApmLearnedMatch.setWorkId(rs.getString(WRK_ID));
                outApmLearnedMatch.setSupplierCode(rs.getString(SUPP_CODE));
                outApmLearnedMatch.setPerformerName(rs.getString(PFR_NA));
                outApmLearnedMatch.setWriterName(rs.getString("WRITER"));
                outApmLearnedMatch.setWorkTitle(rs.getString(WRK_TTL));
                outApmLearnedMatch.setApmMatchType(rs.getString("APM_MATCH_TYP"));
                outApmLearnedMatch.setDeleteFlag(rs.getString("DEL_FL"));
                outApmLearnedMatch.setLearnedDeleteFlag(rs.getString("LRN_DEL"));
                outApmLearnedMatch.setCloneCount(rs.getString("CLONE_CNT"));
            }
        } catch (Exception e) {
            log.error(e);
            throw new PrepSystemException(ERROR_USAGE_SQL_SQLEXCEPTION, e);
        }
        log.debug("Exiting getApmLearnedMatch method in UsageDAOImpl ");
    ...
    public ApmLearnedMatchList getApmLearnedMatchList(ApmLearnedMatchList apmLearnedMatchList)
        throws PrepSystemException {
        log.debug("Entering UsageDAOImpl - getApmLearnedMatchList method ");
        if (apmLearnedMatchList == null) {
            log.debug("Input VOB is null... Returning null");
        } else {
            log.debug("Input Criteria : " + apmLearnedMatchList);
        }
        ...
        try {
            selectQry = new StringBuilder(UsageQueries.GET_APM_LEARNED_MATCH_LIST_START);

            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatchList.getFilterSupplierCode())) {
                if ("ALL_SUPPLIERS".equals(apmLearnedMatchList.getFilterSupplierCode())) {
                    selectQry.append(" AND A.SUPP_CODE IS NULL ");
                } else {
                    selectQry.append(AND_SUPP_CODE);
                    params.add(apmLearnedMatchList.getFilterSupplierCode());
                }
            }

            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatchList.getFilterPerformerName())) {
                if ("CNTS".equals(apmLearnedMatchList.getPerformerSearchType())) {
                    selectQry.append(
                        " AND CATSEARCH(A.PFR_NA, ( SELECT  PKG_SEARCH_UTILS.FNC_FORMAT_SEARCH_PARAM(?, 'NAME', 'CNTS') FROM DUAL), '') > 0");
                    params.add(apmLearnedMatchList.getFilterPerformerName());
                } else {
                    selectQry.append(
                        " AND A.PFR_NA LIKE ( SELECT  PKG_SEARCH_UTILS.FNC_FORMAT_SEARCH_PARAM(?, 'NAME', 'BGNS') FROM DUAL)");
                    params.add(apmLearnedMatchList.getFilterPerformerName());
                }
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatchList.getFilterWorkTitle())) {
                if ("CNTS".equals(apmLearnedMatchList.getWorkTitleSearchType())) {
                    selectQry.append(
                        " AND CATSEARCH(A.WRK_TTL, ( SELECT  PKG_SEARCH_UTILS.FNC_FORMAT_SEARCH_PARAM(?, 'TITLE', 'CNTS') FROM DUAL), '') > 0");
                    params.add(apmLearnedMatchList.getFilterWorkTitle());
                } else {
                    selectQry.append(
                        " AND A.WRK_TTL LIKE ( SELECT  PKG_SEARCH_UTILS.FNC_FORMAT_SEARCH_PARAM(?, 'TITLE', 'BGNS') FROM DUAL)");
                    params.add(apmLearnedMatchList.getFilterWorkTitle());
                }
            }

            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatchList.getFilterWorkId())) {
                selectQry.append(" AND A.WRK_ID = ? ");
                params.add(apmLearnedMatchList.getFilterWorkId());
            }

            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatchList.getFilterMatchTypeCode())) {
                if ("MATCH".equals(apmLearnedMatchList.getFilterMatchTypeCode())) {
                    selectQry.append(" AND A.LRN_DEL = 'N' ");
                } else if ("DELETE".equals(apmLearnedMatchList.getFilterMatchTypeCode())) {
                    selectQry.append(" AND A.LRN_DEL = 'Y' ");
                }
            }

            selectQry.append(UsageQueries.GET_APM_LEARNED_MATCH_LIST_END);

            if (UsageCommonValidations.isEmptyOrNull(apmLearnedMatchList.getFilterPerformerName())) {
                selectQry.append(UsageQueries.GET_APM_LEARNED_MATCH_WRITER_LIST_START);
                ...
                selectQry.append(UsageQueries.GET_APM_LEARNED_MATCH_WRITER_LIST_END);
            }
            selectQry.append(UsageQueries.GET_APM_LEARNED_MATCH_MAIN_END);

            if (apmLearnedMatchList.getNavigationType() == null) {
                if (apmLearnedMatchList.getNumberOfRecordsFound() <= 0) {
                    apmLearnedMatchList.setNumberOfRecordsFound(10);
                } else {
                    apmLearnedMatchList.setNumberOfRecordsFound(apmLearnedMatchList.getNumberOfRecordsFound());
                }
            } else {
                if (apmLearnedMatchList.getNumberOfRecordsFound() <= 0
                    && apmLearnedMatchList.getCurrentPageNumber() > 1) {
                    apmLearnedMatchList.setCurrentPageNumber(apmLearnedMatchList.getCurrentPageNumber() - 1);
                    apmLearnedMatchList.setNumberOfRecordsFound(10);
                } else {
                    apmLearnedMatchList.setNumberOfRecordsFound(apmLearnedMatchList.getNumberOfRecordsFound());
                }
            ...
            int fromIndex = apmLearnedMatchList.getFromIndex();
            int toIndex = apmLearnedMatchList.getToIndexWithoutCount() - 1;
            log.debug("From Index: " + fromIndex);
            log.debug("To Index: " + toIndex);
            log.debug("getApmLearnedMatchList getCurrentPageNumber:" + apmLearnedMatchList.getCurrentPageNumber());

            log.debug("Search Query \n" + selectQry);
            params.add(fromIndex);
            params.add(toIndex);
            SqlRowSet rs = ascapJdbcTemplate.queryForRowSet(selectQry.toString(), params.toArray());

            int totalRecordsFound = 0;
            while (rs.next()) {
                apmLearnedMatch = new ApmLearnedMatch();
                apmLearnedMatch.setSupplierCode(rs.getString(SUPP_CODE));
                apmLearnedMatch.setPerformerName(rs.getString(PFR_NA));
                apmLearnedMatch.setWorkTitle(rs.getString(WRK_TTL));
                apmLearnedMatch.setOriginalWorkId(rs.getString(WRK_ID));
                apmLearnedMatch.setWorkId(rs.getString(WRK_ID));
                apmLearnedMatch.setLearnedDeleteFlag(rs.getString("LRN_DEL"));
                apmLearnedMatch.setLearnType("Y".equals(apmLearnedMatch.getLearnedDeleteFlag()) ? "Delete" : "Match");
                apmLearnedMatch.setMultWorkId(rs.getString("MULT_WRK_ID"));
                apmLearnedMatch.setWriterName(rs.getString("WRITER"));
                apmLearnedMatch.setLmType(rs.getString("LM_TYP"));
                apmLearnedMatch.setCloneCount(rs.getString("CLONE_CNT"));
                totalRecordsFound = rs.getInt("TOTALROWS");
                col.add(apmLearnedMatch);
            }
            apmLearnedMatchList.setNumberOfRecordsFound(totalRecordsFound);
        ...
        apmLearnedMatchList.setSearchResults(col);

        log.debug("Exiting UsageDAOImpl - getApmLearnedMatchList method: No Of Results: " + col.size());
        return apmLearnedMatchList;

    }

    @Override
    public ApmLearnedMatchList deleteApmLearnedMatchListMultiple(ApmLearnedMatchList apmLearnedMatchList)
        throws PrepSystemException {
        log.debug("Entering deleteApmLearnedMatchListMultiple in UsageDAOImpl");
        ...
        ApmLearnedMatch apmRequest = null;
        boolean firstResult = true;
        List<Object> params = new ArrayList<>();
        try {
            while (itr.hasNext()) {
                apmRequest = (ApmLearnedMatch) itr.next();
                log.debug("apmLearnedMatch::::::::::::::" + apmRequest);

                if (firstResult) {
                    this.updateLMBulkUpdateRequest(apmRequest);
                    firstResult = false;
                }
                ...
                if (!ValidationUtils.isEmptyOrNull(apmRequest.getPerformerName())) {
                    updateQuery = new StringBuilder(UsageQueries.DELETE_APM_LEARNED_MATCH);
                } else {
                    updateQuery = new StringBuilder(UsageQueries.DELETE_APM_LEARNED_MATCH_WTR);
                }
                ...
                updateQuery.append(" AND MULT_WRK_ID = ?");

                log.debug("DELETE_APM_LEARNED_MATCH:: " + updateQuery.toString());
                int i = 0;
                params.add(apmRequest.getUserId());

                if (!ValidationUtils.isEmptyOrNull(apmRequest.getPerformerName())) {
                    params.add(apmRequest.getPerformerName());
                } else {
                    params.add(apmRequest.getWriterName());
                }
                ...
                params.add(apmRequest.getMultWorkId());
                int validCount = ascapJdbcTemplate.update(updateQuery.toString(), params.toArray());
                log.debug("Total Params: " + i + " Update  count " + validCount);
            }
        } catch (Exception se) {
            log.error(se.getMessage());
            throw new PrepSystemException(ERROR_USAGE_SQL_SQLEXCEPTION, se);
        ...
        log.debug("Exiting deleteApmLearnedMatchListMultiple in UsageDAOImpl");
        return apmLearnedMatchList;
    }
    ...
    public ApmLearnedMatchList deleteApmLearnedMatchList(ApmLearnedMatchList apmLearnedMatchList)
        throws PrepSystemException {
        log.debug("Entering deleteApmLearnedMatchList in UsageDAOImpl");
        List<Object> col = apmLearnedMatchList.getSearchResults();
        Iterator<Object> itr = null;
        if (col == null) {
            log.debug(INPUT_COLLECTION);
        ...
        try {
            while (itr.hasNext()) {
                ...
                this.updateLMBulkUpdateRequest(apmRequest);
                StringBuilder updateQuery = null;
                if ("PFR".endsWith(apmRequest.getLmType())) {
                    updateQuery = new StringBuilder(UsageQueries.DELETE_APM_LEARNED_MATCH);
                } else {
                    updateQuery = new StringBuilder(UsageQueries.DELETE_APM_LEARNED_MATCH_WTR);
                }
                ...
                if (ValidationUtils.isEmptyOrNull(apmRequest.getOriginalWorkId())) {
                    updateQuery.append(" AND WRK_ID IS NULL ");
                } else {
                    updateQuery.append(" AND WRK_ID = ?");
                }
                ...
                int validCount = ascapJdbcTemplate.update(updateQuery.toString(), params.toArray());
                log.debug("Total Params: " + params.size() + " Update  count " + validCount);
            }
        } catch (Exception se) {
            log.error(se.getMessage());
            throw new PrepSystemException(ERROR_USAGE_SQL_SQLEXCEPTION, se);
        ...
        log.debug("Exiting deleteApmLearnedMatchList in UsageDAOImpl");
        return apmLearnedMatchList;
    }

    private ApmLearnedMatch updateLMBulkUpdateRequest(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering updateLMBulkUpdateRequest method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
        ApmLearnedMatch origUpdateRequest = this.getLMBulkUpdateRequest(apmLearnedMatch);
        if (origUpdateRequest == null) {
            log.debug("LM Bulk Update Request does not exists... nothing to update. ");
            return apmLearnedMatch;
        }
        List<Object> params = new ArrayList<>();
        try {
            String origUpdateRequestId = origUpdateRequest.getRequestId();
            params.add(UsageConstants.LM_BULK_UPD_REQ_STATUS_CANCELLED);
            params.add(apmLearnedMatch.getUserId());
            params.add(origUpdateRequestId);
            ascapJdbcTemplate.update(UsageQueries.UPDATE_LM_BULK_UPD_REQ, params.toArray());
        } catch (Exception se) {
            log.error(se.getMessage());
            throw new PrepSystemException(ERROR_USAGE_SQL_SQLEXCEPTION, se);

        }
        log.debug("Exiting addLMBulkUpdateRequest method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
        return apmLearnedMatch;
    }

    private ApmLearnedMatch getLMBulkUpdateRequest(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering getLMBulkUpdateRequest method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
        if (apmLearnedMatch == null) {
            log.debug("Invalid Input object, returning null");
            return null;
        }
        ApmLearnedMatch outApmLearnedMatch = null;
        StringBuilder qry = null;
        ...
        try {
            qry = new StringBuilder(UsageQueries.GET_LM_BULK_UPD_REQ);
            params.add(UsageConstants.LM_BULK_UPD_REQ_STATUS_PENDING);
            params.add(apmLearnedMatch.getWorkTitle());
            if ("PFR".equals(apmLearnedMatch.getLmType())) {
                qry.append(" AND PFR_NA = ?");
                params.add(apmLearnedMatch.getPerformerName());
            } else if ("WTR".equals(apmLearnedMatch.getLmType())) {
                qry.append(" AND WRITER = ?");
                params.add(apmLearnedMatch.getWriterName());
            }

            if (ValidationUtils.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
                qry.append(AND_SUPP_CODE_NULL);
            } else {
                qry.append(AND_SUPP_CODE_QNMRK);
                params.add(apmLearnedMatch.getSupplierCode());
            }
            log.debug("Executing Query: " + qry.toString());
            SqlRowSet rs = ascapJdbcTemplate.queryForRowSet(qry.toString(), params.toArray());
            while (rs.next()) {
                outApmLearnedMatch = new ApmLearnedMatch();
                outApmLearnedMatch.setRequestId(rs.getString("LM_BULK_UPD_REQ_ID"));
            }
        } catch (Exception se) {
            log.error(se.getMessage());
            throw new PrepSystemException(ERROR_USAGE_SQL_SQLEXCEPTION, se);
        }
        log.debug("Exiting getLMBulkUpdateRequest method in UsageDAOImpl apmLearnedMatch " + outApmLearnedMatch);
        return outApmLearnedMatch;

    }

    private ApmLearnedMatch getApmLearnedMatchOriginal(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering getApmLearnedMatchOriginal method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
        ApmLearnedMatch outApmLearnedMatch = null;
        ArrayList<String> searchValuesList = new ArrayList<String>();
        StringBuilder sb = null;
        if ("PFR".equals(apmLearnedMatch.getLmType())) {
            sb = new StringBuilder(UsageQueries.GET_ORIG_WRK_APM_LEARNED_MATCH_START);
        } else if ("WTR".equals(apmLearnedMatch.getLmType())) {
            sb = new StringBuilder(UsageQueries.GET_ORIG_WRK_APM_LEARNED_MATCH_WTR_START);
        }
        if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
            sb.append(AND_SUPP_CODE);
            searchValuesList.add(apmLearnedMatch.getSupplierCode());
        ...
        try {
            ...
            ArrayList<String> cloneCountList = new ArrayList<>();
            ArrayList<String> workCountList = new ArrayList<>();
            boolean resultFound = false;
            while (rs.next()) {
                resultFound = true;
                workList.add(rs.getString(WRK_ID));
                cloneCountList.add(rs.getString("CLONE_CNT"));
                workCountList.add(rs.getString(WRK_ID) + ":" + rs.getString("CLONE_CNT"));
            }

            if (resultFound) {
                outApmLearnedMatch = new ApmLearnedMatch();
                outApmLearnedMatch.setWorkIdCollection(workList);
                outApmLearnedMatch.setCloneCountsCollection(cloneCountList);
                outApmLearnedMatch.setWorkCountCollection(workCountList);
            }
        ...
        log.debug("Exiting getApmLearnedMatch method in UsageDAOImpl outApmLearnedMatch " + outApmLearnedMatch);

        return outApmLearnedMatch;
    }

    private ApmLearnedMatch addLMBulkUpdateRequest(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering addLMBulkUpdateRequest method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
        if (this.getLMBulkUpdateRequest(apmLearnedMatch) != null) {
            log.debug("LM Bulk Update Request exists... not inserting a new one. ");
            return apmLearnedMatch;
        }
        try {
            ApmLearnedMatch origLM = this.getApmLearnedMatchOriginal(apmLearnedMatch);
            List<String> newWorkCollection = apmLearnedMatch.getWorkIdCollection();
            List<String> newCloneCntCollection = apmLearnedMatch.getCloneCountsCollection();
            List<String> workCountList = new ArrayList<>();
            List<String> newWorkCountList = new ArrayList<>();
            StringBuilder orgiWorkString = new StringBuilder();
            if (origLM != null) {
                workCountList = origLM.getWorkCountCollection();
                if (workCountList != null && !workCountList.isEmpty()) {
                    for (String w : workCountList) {
                        orgiWorkString.append(w);
                        orgiWorkString.append("|");
                    }
                    if (orgiWorkString.length() > 0) {
                        orgiWorkString.setLength(orgiWorkString.length() - 1);
                    }
                }
            }

            if (newWorkCollection != null && !newWorkCollection.isEmpty()) {
                int i = 0;
                for (String w : newWorkCollection) {
                    newWorkCountList.add(w + ":" + newCloneCntCollection.get(i));
                    i++;
                }

            }
            if (workCountList == null || newWorkCollection == null || newCloneCntCollection == null) {
                log.debug("INVALID INPUTS.. returning...... just making sure nothing is null");
                return apmLearnedMatch;
            }

            boolean valuesChanged = false;

            if (workCountList.size() != newWorkCountList.size()) {
                valuesChanged = true;
            } else if (!workCountList.containsAll(newWorkCountList)) {
                valuesChanged = true;
            }

            if (valuesChanged) {

                String lmBulkUpdateRequestId =
                    this.getSequence(UsageQueries.GET_SEQUENCE_LM_BULK_UPD_REQ_ID, ascapJdbcTemplate);
                List<Object> params = new ArrayList<>();
                params.add(lmBulkUpdateRequestId);
                params.add(UsageConstants.LM_BULK_UPD_REQ_STATUS_PENDING);
                params.add(apmLearnedMatch.getSupplierCode());
                params.add(apmLearnedMatch.getWorkTitle());
                params.add(apmLearnedMatch.getPerformerName());
                params.add(apmLearnedMatch.getWriterName());
                params.add(apmLearnedMatch.getMultWorkId()); // ORIG_MULT_WRK_ID
                params.add(orgiWorkString.toString()); // ORIG_WRK_ID
                params.add(apmLearnedMatch.getUserId());
                ascapJdbcTemplate.update(UsageQueries.INSERT_LM_BULK_UPD_REQ, params.toArray());
            } else {
                log.debug("NOTHING CHANGED..... NOTHING TO UPDATE OR INSERT");
            }
    ...
    @Override
    public ApmLearnedMatchList updateApmLearnedMatchList(ApmLearnedMatchList apmLearnedMatchList)
        throws PrepSystemException {
        log.debug("Entering updateApmLearnedMatchList in UsageDAOImpl");
        List<Object> col = apmLearnedMatchList.getSearchResults();
        Iterator<Object> itr = null;
            ...
            while (itr.hasNext()) {
                ...
                if (apmRequest != null) {
                    if (ValidationUtils.isEmptyOrNull(apmRequest.getWorkTitle())
                        ...
                        log.debug(
                            "Inside updateLearnedkMatch.. Work Tiltle or (Performer Name and Writer ) is null, so continuing for next group");
                        continue;
                    }
                }
                this.addLMBulkUpdateRequest(apmRequest);

                int count = 0;
                if (count <= 0) {
                    StringBuilder updateQuery = null;

                    updateQuery = new StringBuilder(UsageQueries.UPDATE_APM_LEARNED_MATCH_EVEN_DELETED_START);

                    if ("PFR".equals(apmRequest.getLmType())) {
                        updateQuery.append(" APM_LEARNED_MATCH ");
                    } else if ("WTR".equals(apmRequest.getLmType())) {
                        updateQuery.append(" APM_LEARNED_MATCH_WTR ");
                    } else {
                        log.debug("Invalid LM Type received in input... returning");
                        return apmLearnedMatchList;
                    }

                    updateQuery.append(UsageQueries.UPDATE_APM_LEARNED_MATCH_EVEN_DELETED_END);

                    if ("PFR".equals(apmRequest.getLmType())) {
                        updateQuery.append(" AND PFR_NA = ? ");
                    } else if ("WTR".equals(apmRequest.getLmType())) {
                        updateQuery.append(" AND WRITER = ? ");
                    }
                    ...
                    log.debug("UPDATE_APM_LEARNED_MATCH_EVEN_DELETED:: " + updateQuery.toString());

                    params.add(apmRequest.getUserId());
                    params.add(apmRequest.getLearnedDeleteFlag());
                    params.add(apmRequest.getWorkTitle());
                    params.add(apmRequest.getWorkId());
                    params.add("PFR".equals(apmRequest.getLmType()) ? apmRequest.getPerformerName()
                        : apmRequest.getWriterName());
                    if (!ValidationUtils.isEmptyOrNull(apmRequest.getSupplierCode())) {
                        params.add(apmRequest.getSupplierCode());
                    }
                    int existsCount = ascapJdbcTemplate.update(updateQuery.toString(), params.toArray());
                    log.debug(" updated exsisting with new work id count :" + existsCount);
                    params = new ArrayList<>();
                    if (existsCount > 0) {
                        if ("PFR".equals(apmRequest.getLmType())) {
                            updateQuery = new StringBuilder(UsageQueries.DELETE_INVALID_APM_LEARNED_MATCH);
                        } else if ("WTR".equals(apmRequest.getLmType())) {
                            updateQuery = new StringBuilder(UsageQueries.DELETE_INVALID_APM_LEARNED_MATCH_WTR);
                        }
                        ...
                        log.debug("UPDATE_ORIGINAL_APM_LEARNED_MATCH:: " + updateQuery.toString());
                        ...
                        params.add(apmRequest.getWorkId());
                        if (!ValidationUtils.isEmptyOrNull(apmRequest.getSupplierCode())) {
                            log.debug("SUPPLEIR CODE IS NOT NULL");
                            params.add(apmRequest.getSupplierCode());
                        }
                        int validCount = ascapJdbcTemplate.update(updateQuery.toString(), params.toArray());
                        log.debug("Update Everything eelse count " + validCount);

                    } else {
                        if ("PFR".equals(apmRequest.getLmType())) {
                            updateQuery = new StringBuilder(UsageQueries.UPDATE_ORIGINAL_APM_LEARNED_MATCH);
                        } else if ("WTR".equals(apmRequest.getLmType())) {
                            updateQuery = new StringBuilder(UsageQueries.UPDATE_ORIGINAL_APM_LEARNED_MATCH_WTR);
                        }
                        ...
                        int validCount = ascapJdbcTemplate.update(updateQuery.toString(), params.toArray());
                        log.debug("update original count " + validCount);
                    }
                }
            }
        } catch (Exception se) {
        ...
        log.debug("Exiting updateApmLearnedMatchList in UsageDAOImpl");
        return apmLearnedMatchList;
    }
    ...
    public ApmLearnedMatch getLearnedMatchMedleyWorkInformation(ApmLearnedMatchList apmLearnedMatchList)
        throws PrepSystemException {
        log.debug("Entering getLearnedMatchMedleyWorkInformation in UsageDAOImpl.. LM Type: "
            + apmLearnedMatchList.getLearnedMatchType());
        ApmLearnedMatch apmLearnedMatch = new ApmLearnedMatch();

        List<String> wrkList = new ArrayList<>();
        List<String> cloneCountList = new ArrayList<>();
        String[] workIdArray = null;
        String[] cloneCountArray = null;
        String performerName = null;
        ...
        String supplierCode = null;
        String workTitle = null;
        String learnedDeleteFlag = null;
        String multWorkId = null;
        try {

            if (!ValidationUtils.isEmptyOrNull(apmLearnedMatchList.getMedleyMultiWorkId())) {

                String qry = null;
                if ("APM_LEARNED_MATCH".equals(apmLearnedMatchList.getLearnedMatchType())) {
                    qry =
                        " SELECT  WRK_ID, SUPP_CODE, WRK_TTL, PFR_NA, LRN_DEL, MULT_WRK_ID, CLONE_CNT, NULL WRITER  FROM APM_LEARNED_MATCH WHERE MULT_WRK_ID = ? AND DEL_FL = 'N' ";
                } else if ("APM_LEARNED_MATCH_WTR".equals(apmLearnedMatchList.getLearnedMatchType())) {
                    qry =
                        " SELECT  WRK_ID, SUPP_CODE, WRK_TTL, NULL PFR_NA, LRN_DEL, MULT_WRK_ID, CLONE_CNT, WRITER  FROM APM_LEARNED_MATCH_WTR WHERE MULT_WRK_ID = ? AND DEL_FL = 'N' ";
                }
                List<Object> params = new ArrayList<>();
                params.add(apmLearnedMatchList.getMedleyMultiWorkId());
                SqlRowSet rs = ascapJdbcTemplate.queryForRowSet(qry.toString(), params.toArray());
                while (rs.next()) {
                    wrkList.add(rs.getString(WRK_ID));
                    cloneCountList.add(rs.getString("CLONE_CNT"));
                    supplierCode = rs.getString("SUPP_CODE");
                    performerName = rs.getString("PFR_NA");
                    workTitle = rs.getString(WRK_TTL);
                    learnedDeleteFlag = rs.getString("LRN_DEL");
                    multWorkId = rs.getString("MULT_WRK_ID");
                    writerName = rs.getString("WRITER");
                }
        ...
        apmLearnedMatch.setWorkIds(workIdArray);
        apmLearnedMatch.setWorkIdCollection(wrkList);
        apmLearnedMatch.setMedleyCloneCounts(cloneCountArray);
        apmLearnedMatch.setCloneCountsCollection(cloneCountList);
        apmLearnedMatch.setSupplierCode(supplierCode);
        apmLearnedMatch.setPerformerName(performerName);
        apmLearnedMatch.setWriterName(writerName);
        apmLearnedMatch.setWorkTitle(workTitle);
        apmLearnedMatch.setLearnedDeleteFlag(learnedDeleteFlag);
        apmLearnedMatch.setMultWorkId(multWorkId);
        log.debug("Exiting getLearnedMatchMedleyWorkInformation in UsageDAOImpl");
        return apmLearnedMatch;
    }

    @Override
    public ApmLearnedMatch updateApmLearnedMatchMultiple(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {

        log.debug("Entering updateApmLearnedMatchMultiple method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);

        if (apmLearnedMatch == null || apmLearnedMatch.getWorkIdCollection() == null
            || apmLearnedMatch.getWorkIdCollection().size() <= 0) {
            log.debug("Input is is null or work ids are null");
            return apmLearnedMatch;
        }
        List<String> workIdList = apmLearnedMatch.getWorkIdCollection();
        List<String> cloneCountsCollection = apmLearnedMatch.getCloneCountsCollection();
        String multWorkId = apmLearnedMatch.getMultWorkId();
        StringBuilder updateSoftDeleteAll = null;
        StringBuilder updateQry = null;
        StringBuilder insertQry = null;

        String learnedMatchType = apmLearnedMatch.getLearnedMatchType();
        List<Object> params = new ArrayList<>();

        try {

            this.addLMBulkUpdateRequest(apmLearnedMatch);

            if ("APM_LEARNED_MATCH".equals(learnedMatchType)) {
                updateSoftDeleteAll = new StringBuilder(
                    "UPDATE APM_LEARNED_MATCH SET DEL_FL = 'Y', UPD_ID = ?, UPD_DT = SYSDATE, MULT_WRK_ID = NULL WHERE WRK_TTL = ? AND PFR_NA = ? AND DEL_FL = 'N' ");
            } else if ("APM_LEARNED_MATCH_WTR".equals(learnedMatchType)) {
                updateSoftDeleteAll = new StringBuilder(
                    "UPDATE APM_LEARNED_MATCH_WTR SET DEL_FL = 'Y', UPD_ID = ?, UPD_DT = SYSDATE, MULT_WRK_ID = NULL WHERE WRK_TTL = ? AND WRITER = ? AND DEL_FL = 'N' ");
            } else {
                log.debug("Cannot Determine Learned Match Type.. returning from DAO");
            }
            if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
                updateSoftDeleteAll.append(AND_SUPP_CODE_QNMRK);
            } else {
                updateSoftDeleteAll.append(AND_SUPP_CODE_NULL);
            }
            ...
            int updCount = ascapJdbcTemplate.update(updateSoftDeleteAll.toString(), params.toArray());
            log.debug("Set DELFL Y to " + updCount);
            if (workIdList.size() > 1 && ValidationUtils.isEmptyOrNull(multWorkId)) {
                log.debug("Getting sequeence   SELECT PAPM.MULT_WRK_ID.NEXTVAL FROM DUAL ");
                multWorkId = this.getSequence("SELECT PAPM.MULT_WRK_ID.NEXTVAL FROM DUAL", ascapJdbcTemplate);
            } else if (workIdList.size() == 1) {
                multWorkId = null;
            }
            int i = -1;
            for (String w : workIdList) {
                i++;
                log.debug("apmLearnedMatch " + apmLearnedMatch);

                if ("APM_LEARNED_MATCH".equals(learnedMatchType)) {
                    updateQry = new StringBuilder(
                        "UPDATE APM_LEARNED_MATCH SET DEL_FL = 'N', MULT_WRK_ID = ?, UPD_ID = ?, CLONE_CNT = ?, UPD_DT = SYSDATE, LRN_DEL = 'N' WHERE WRK_TTL = ? AND PFR_NA = ? AND WRK_ID = ? ");
                } else if ("APM_LEARNED_MATCH_WTR".equals(learnedMatchType)) {
                    updateQry = new StringBuilder(
                        "UPDATE APM_LEARNED_MATCH_WTR SET DEL_FL = 'N', MULT_WRK_ID = ?, UPD_ID = ?, CLONE_CNT = ?, UPD_DT = SYSDATE, LRN_DEL = 'N' WHERE WRK_TTL = ? AND WRITER = ? AND WRK_ID = ? ");
                }

                if (!ValidationUtils.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
                    updateQry.append(AND_SUPP_CODE_QNMRK);
                } else {
                    updateQry.append(AND_SUPP_CODE_NULL);
                }
                params = new ArrayList<>();
                params.add(multWorkId);
                params.add(apmLearnedMatch.getUserId());
                ...
                log.debug("Executing 1x query " + updateQry.toString());
                updCount = ascapJdbcTemplate.update(updateQry.toString(), params.toArray());

                log.debug("Update Count for Work ID " + w + "  " + updCount);
                if (updCount <= 0) {
                    log.debug("Inserting new row for Work ID " + w);

                    if ("APM_LEARNED_MATCH".equals(learnedMatchType)) {
                        insertQry = new StringBuilder(
                            " INSERT INTO APM_LEARNED_MATCH (SUPP_CODE, PFR_NA, WRK_TTL, WRK_ID, CRE_ID, MULT_WRK_ID, LRN_DEL, APM_MATCH_TYP, DEL_FL, CRE_DT, CLONE_CNT) VALUES (?,?,?,?,?,?,'N','LRN','N',SYSDATE,?) ");
                    } else if ("APM_LEARNED_MATCH_WTR".equals(learnedMatchType)) {
                        insertQry = new StringBuilder(
                            " INSERT INTO APM_LEARNED_MATCH_WTR (SUPP_CODE, WRITER, WRK_TTL, WRK_ID, CRE_ID, MULT_WRK_ID, LRN_DEL, APM_MATCH_TYP, DEL_FL, CRE_DT, CLONE_CNT) VALUES (?,?,?,?,?,?,'N','LRN','N',SYSDATE,?) ");
                    }
                    params = new ArrayList<>();
                    params.add(apmLearnedMatch.getSupplierCode());
                    if ("APM_LEARNED_MATCH".equals(learnedMatchType)) {
                    ...
                    params.add(multWorkId);
                    params.add(cloneCountsCollection.get(i));
                    ascapJdbcTemplate.update(insertQry.toString(), params.toArray());
                }
            }
        ...
        log.debug("Exiting updateApmLearnedMatchMultiple method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
    ...
    @Override
    public ApmWork validateWorkIdForLearnedMatch(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering validateWorkIdForLearnedMatch(ApmLearnedMatch) + " + apmLearnedMatch);
        ApmWork work = null;
        try {
            SqlRowSet rs = ascapJdbcTemplate.queryForRowSet(
                "SELECT WRK_ID,  WRK_TYP_CDE, nvl(SUR_WRK_IND,'N') SUR_WRK_IND, nvl(POSS_MCH_IND,'N') POSS_MCH_IND, nvl(WRK_GRD_VAL,0) WRK_GRD_VAL, nvl(PUB_DOM_IND,'N') PUB_DOM_IND "
                    + "  FROM   mvw_wrk  WHERE  WRK_ID = ? ",
                new Object[] {apmLearnedMatch.getWorkId()});
            if (rs.next()) {
                work = new ApmWork();
                work.setWorkTypeCode(rs.getString("WRK_TYP_CDE"));
                work.setPublicDomainIndicator(rs.getString("PUB_DOM_IND"));
                work.setWorkGradingValue(rs.getLong("WRK_GRD_VAL"));
            }
        ...
        log.debug("Exiting validateWorkIdForLearnedMatch");
        return work;
    }

    @Override
    public ApmLearnedMatch updateApmLearnedMatch(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering updateApmLearnedMatch in UsageDAOImpl, apmLearnedMatch " + apmLearnedMatch);
        if (apmLearnedMatch == null) {
            log.debug("Input object is null... returning");
            return apmLearnedMatch;
        }
        ...
        try {
            ...
            String query =
                "UPDATE APM_LEARNED_MATCH SET DEL_FL = 'N', LRN_DEL = ?, UPD_DT = SYSDATE, APM_MATCH_TYP = 'LRN', WRK_ID = ?, UPD_ID  = ?, MULT_WRK_ID = NULL "
                    + " WHERE WRK_TTL = ? AND PFR_NA = ? AND WRK_ID = ? ";

            if (ValidationUtils.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
                query += AND_SUPP_CODE_NULL;
            } else {
                query += AND_SUPP_CODE_QNMRK;
            }

            log.debug(EXECUTING_QUERY + query);

            params.add(apmLearnedMatch.getLearnedDeleteFlag());
            params.add(apmLearnedMatch.getWorkId());
            params.add(apmLearnedMatch.getUserId());
            params.add(apmLearnedMatch.getWorkTitle());
            params.add(apmLearnedMatch.getPerformerName());
            params.add(apmLearnedMatch.getWorkId());
            ...
            int updateCount = ascapJdbcTemplate.update(query, params.toArray());

            if (updateCount <= 0) {
                this.addApmLearnedMatch(apmLearnedMatch);
            }

            log.debug("Updated a soft deleted record. update count: " + updateCount);
        ...
        log.debug("Exiting updateApmLearnedMatch in UsageDAOImpl");

        return apmLearnedMatch;
    }

    @Override
    public ApmLearnedMatch addApmLearnedMatch(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {

        log.debug("Entering addApmLearnedMatch of UsageDAOImpl ApmLearnedMatch :" + apmLearnedMatch);
        StringBuilder sqlStr;

        StringBuilder columnsPart;
        StringBuilder valuesPart;
        ArrayList<String> valuesList;
        if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getPerformerName())) {
            sqlStr = new StringBuilder(UsageQueries.DYNAMIC_INSERT_APM_LEARNED_MATCH);
        } else {
            sqlStr = new StringBuilder(UsageQueries.DYNAMIC_INSERT_APM_LEARNED_MATCH_WTR);
        }
        columnsPart = new StringBuilder(" (");
        valuesPart = new StringBuilder(VALUES);
        ...
        try {
            ...
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getSupplierCode())) {
                columnsPart.append(SUPPCODE);
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getSupplierCode());
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getWorkTitle())) {
                columnsPart.append(COMMA_WRK_TTL);
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getWorkTitle());
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getPerformerName())) {
                columnsPart.append(PFR_NA_COMMA);
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getPerformerName());
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getWriterName())) {
                columnsPart.append(COMMA_WRITER);
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getWriterName());
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getWorkId())) {
                columnsPart.append(COMMA_WRK_ID);
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getWorkId());
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getLearnedDeleteFlag())) {
                columnsPart.append(", LRN_DEL");
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getLearnedDeleteFlag());
            }
            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getMultWorkId())) {
                columnsPart.append(", MULT_WRK_ID ");
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getMultWorkId());
            }

            if (!UsageCommonValidations.isEmptyOrNull(apmLearnedMatch.getCloneCount())) {
                columnsPart.append(", CLONE_CNT ");
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getCloneCount());
            }
            if (apmLearnedMatch.getUserId() != null) {
                columnsPart.append(CRE_ID);
                valuesPart.append(", ?");
                valuesList.add(apmLearnedMatch.getUserId());
            }
            ...
            ascapJdbcTemplate.update(sqlStr.toString(), valuesList.toArray());
    ...
    @Override
    public ApmLearnedMatch addApmLearnedMatchMultiple(ApmLearnedMatch apmLearnedMatch) throws PrepSystemException {
        log.debug("Entering addApmLearnedMatchMultiple method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);
        ...
        List<String> workIdList = apmLearnedMatch.getWorkIdCollection();
        List<String> cloneCountsList = apmLearnedMatch.getCloneCountsCollection();
        ...
        try {
            ...
            int i = 0;
            for (String w : workIdList) {
                apmLearnedMatch.setWorkId(w);
                apmLearnedMatch.setCloneCount(cloneCountsList.get(i));
                addApmLearnedMatch(apmLearnedMatch);
                i++;
            }
        ...
        log.debug("Exiting addApmLearnedMatchMultiple method in UsageDAOImpl apmLearnedMatch " + apmLearnedMatch);

        return apmLearnedMatch;
    }

    @Override
    public ApmFileUpload loadFile2Usage(ApmFileUpload usageFile) throws PrepSystemException {
        log.debug("Entering loadFile2Usage in UsageDAOImpl");
        String loadMusicUserWeightFileQry = UsageQueries.LOAD_USAGE_FILE;
        String fileId = this.getSequence(UsageQueries.SEQUENCE_IMPORT_FILE_ID, ascapJdbcTemplate);
        usageFile.setFileId(fileId);
        ascapJdbcTemplate.update(new PreparedStatementCreator() {

            @Override
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                PreparedStatement pstmt = con.prepareStatement(loadMusicUserWeightFileQry);
                pstmt.setString(1, fileId);
                pstmt.setString(2, usageFile.getFileName());
                pstmt.setString(3, usageFile.getFileType());
                pstmt.setString(4, DistributionConstants.FILE_STATUS_NEW);
                pstmt.setString(5, usageFile.getTargetYearQuarter());
                pstmt.setString(6, usageFile.getUserId());
                pstmt.setString(7, usageFile.getFileOrigPath());
                return pstmt;
            }
        });
        log.debug("Load RadioFile SQL Query:" + loadMusicUserWeightFileQry);
        log.debug("Exiting loadFile2Usage in UsageDAOImpl");
        return usageFile;
    }
