...
public class LookupTablesHelper {
    ...
    public String getLookupTableItemDescription(String lookupTableKey, String lookupTableItemKey)
        ...
        if (lookupTableCache == null) {
            ...
            throw new InvalidCacheException("error.utils.cache.cachenotfound", errorStrings);
        }
        ...
        if (itemDescription == null) {
            ...
            throw new InvalidCacheException("error.utils.cache.keynotfound", errorStrings);
        }
